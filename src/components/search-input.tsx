...
const SearchInput = () => {
  ...
  return (
    ...
    >
      ...
      <Input
        ref={inputRef}
        className="flex-1 border-none bg-content-background text-primary text-xs font-medium py-3 font-roboto-mono focus:ring-0 focus:ring-offset-0 focus:text-primary focus:placeholder:text-primary"
