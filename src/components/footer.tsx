  ...
  return (
    <footer className="w-full flex flex-wrap justify-around px-4 md:px-8 lg:px-16 xl:px-52 py-4 gap-8">
      ...
      <CreditsCard
        ...
        url="https://github.com/candidelabs"
      />
      <CreditsCard
        title="Audited by"
...
const CreditsCard = ({
  ...
  return (
    <Link href={url} target="_blank" className="flex-shrink-0">
      <div className="flex flex-col items-center justify-center gap-[6px] opacity-40 hover:opacity-100 transition-all">
        <p className="opacity-80 font-medium text-center">{title}</p>
        {imageUrl ? (
