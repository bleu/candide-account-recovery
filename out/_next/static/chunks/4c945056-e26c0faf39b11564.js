...
`,eO=(0,T.AH)`
  ...
  ${eI.ensDark}
  ${eI.graphicsDark}
`,eF="auto",eW=ey(O.P.div)`
  ${eM.default}

  ${e=>{switch(e.$useTheme){case"web95":return eF="light",eM.web95;case"retro":return eF="light",eM.retro;case"soft":return eF="light",eM.soft;case"midnight":return eF="dark",eM.midnight;case"minimal":return eF="light",eM.minimal;case"rounded":return eF="light",eM.rounded;case"nouns":return eF="light",eM.nouns;default:if("light"===e.$useMode)return eF="light",eM.light;if("dark"===e.$useMode)return eF="dark",eM.dark;return(0,T.AH)`
  ...
  ${e=>{switch(eF){case"light":return e_;case"dark":return eO;default:return(0,T.AH)`
          ${e_}
          @media (prefers-color-scheme: dark) {
            ${eO}
          }
...
`,eT=e=>{let{selector:n,children:t}=e={selector:"__CONNECTKIT__",...e},o=(0,M.useRef)(null),[i,r]=(0,M.useState)(!1);return((0,M.useEffect)(()=>{let e="#"+n.replace(/^#/,"");if(o.current=document.querySelector(e),!o.current){let e=document.createElement("div");e.setAttribute("id",n),e.setAttribute("data-connectkit",`${rR}`),document.body.appendChild(e),o.current=e}r(!0)},[n]),o.current&&i)?(0,z.createPortal)(t,o.current):null};var ez={mobileWidth:560};let eD=ey(O.P.div)`
  z-index: -1;
  pointer-events: auto;
  position: absolute;
  left: 50%;
...
`,eX=ey(O.P.div)`
  ...
  @media only screen and (max-width: ${ez.mobileWidth}px) {
    display: block;
  }
`,eJ=ey(O.P.h1)`
  margin: 0;
...
`;let eK=ey(O.P.div)`
  ...
  opacity: 0;
  animation: ${e=>e.$active?eR:eU} 150ms ease-out
    both;
`,e$=(0,T.i7)`
...
Vui l\xf2ng thử lại.`,injectionScreen_notconnected_h1:`Đăng nhập v\xe0o {{ CONNECTORNAME }}`,injectionScreen_notconnected_p:`Để tiếp tục, vui l\xf2ng đăng nhập bằng tiện \xedch {{ CONNECTORNAME }}.`,profileScreen_heading:"Đ\xe3 kết nối",switchNetworkScreen_heading:"Đổi mạng",signInWithEthereumScreen_tooltip:"Bạn chưa đăng nhập v\xe0o ứng dụng.\n**Đăng nhập qua Ethereum** để tiếp tục.",signInWithEthereumScreen_signedOut_heading:"Đăng nhập qua Ethereum",signInWithEthereumScreen_signedOut_h1:"Ứng dụng n\xe0y muốn x\xe1c nhận bạn \n l\xe0 chủ sở hữu của v\xed.",signInWithEthereumScreen_signedOut_p:`Vui l\xf2ng k\xfd tin nhắn y\xeau cầu 
 ...
 x\xe1c nhận lại trong l\xe0n tiếp theo.`,signInWithEthereumScreen_signedIn_button:"Đăng xuất"},nz=e=>{switch(e){case"ee-EE":return nN;case"ar-AE":return nj;case"es-ES":return nE;case"fa-IR":return nL;case"fr-FR":return nA;case"ja-JP":return nM;case"pt-BR":return nI;case"ru-RU":return n_;case"zh-CN":return nO;case"ca-AD":return nF;case"tr-TR":return nW;case"vi-VN":return nT;default:return nS}};function nD(e){var n,t;let o=null!==(t=null===(n=rm().options)||void 0===n?void 0:n.language)&&void 0!==t?t:"en-US",i=(0,M.useMemo)(()=>nz(o),[o]);if(!i)return console.error(`Missing translations for: ${o}`),`Missing translations for: ${o}`;let r={};return Object.keys(i).map(n=>{let t=i[n];return r[n]=nR(t,e)}),r}let nR=(e,n)=>{let t=e;return n&&Object.keys(n).forEach(e=>{t=t.replace(RegExp(`({{ ${e} }})`,"g"),n[e])}),nB(t)},nB=e=>{let n=e;return n=(n=n.split("\n")).map((e,t)=>(0,A.jsxs)(M.Fragment,{children:[nH(e),t<n.length-1&&(0,A.jsx)("br",{})]},t))},nH=e=>e.split(/(\*\*[^\*]*\*\*)/g).map((e,n)=>/(\*\*.*\*\*)/g.test(e)?(0,A.jsx)("strong",{children:e.replace(/\*\*/g,"")},n):`${e}`).map(e=>"string"==typeof e?e.split(/(\[WALLETCONNECTLOGO\])/g).map(e=>"[WALLETCONNECTLOGO]"===e?(0,A.jsx)("span",{className:"ck-tt-logo",children:(0,A.jsx)(er.WalletConnect,{})},e):e):e),nU={debug:10,info:20,warn:30,error:40,none:100},nZ="undefined"!=typeof window&&window.document&&void 0!==window.document.createElement?M.useLayoutEffect:M.useEffect,nG=({logLevel:e="info",maxFontSize:n=100,minFontSize:t=20,onFinish:o,onStart:i,resolution:r=5}={})=>{let a=nU[e],c=(0,M.useCallback)(()=>({calcKey:0,fontSize:n,fontSizePrev:t,fontSizeMax:n,fontSizeMin:t}),[n,t]),s=(0,M.useRef)(null),d=(0,M.useRef)(),l=(0,M.useRef)(!1),[p,h]=(0,M.useState)(c),{calcKey:u,fontSize:g,fontSizeMax:x,fontSizeMin:b,fontSizePrev:m}=p,C=null,[v]=(0,M.useState)(()=>new H.A(()=>{C=window.requestAnimationFrame(()=>{l.current||(i&&i(),l.current=!0,h({...c(),calcKey:u+1}))})}));(0,M.useEffect)(()=>(s.current&&v.observe(s.current),()=>{C&&window.cancelAnimationFrame(C),v.disconnect()}),[C,v]);let f=s.current&&s.current.innerHTML;return(0,M.useEffect)(()=>{0===u||l.current||(f!==d.current&&(i&&i(),h({...c(),calcKey:u+1})),d.current=f)},[u,c,f,i]),nZ(()=>{let e;if(0===u)return;let n=Math.abs(g-m)<=r,i=!!s.current&&(s.current.scrollHeight>s.current.offsetHeight||s.current.scrollWidth>s.current.offsetWidth),c=i&&g===m,d=g>m;if(n){c?(l.current=!1,a<=nU.info&&console.info(`[use-fit-text] reached \`minFontSize = ${t}\` without fitting text`)):i?h({fontSize:d?m:b,fontSizeMax:x,fontSizeMin:b,fontSizePrev:m,calcKey:u}):(l.current=!1,o&&o(g));return}let p=x,C=b;i?(e=d?m-g:b-g,p=Math.min(x,g)):(e=d?x-g:m-g,C=Math.max(b,g)),h({calcKey:u,fontSize:g+e/2,fontSizeMax:p,fontSizeMin:C,fontSizePrev:g})},[u,g,x,b,m,o,s,r]),{fontSize:g,ref:s}},nP=({children:e})=>{let[n,t]=M.useState(!1),{fontSize:o,ref:i}=nG({logLevel:"none",maxFontSize:100,minFontSize:70,onStart:()=>t(!0),onFinish:()=>t(!0)});return(0,A.jsx)("div",{ref:i,style:{visibility:n?"visible":"hidden",fontSize:`${o}%`,maxHeight:"100%",maxWidth:"100%",display:"flex",justifyContent:"center",alignItems:"center"},children:e})};function nV(){let e=(0,c.U)();return null!=e?e:[]}function nY(e,n){let t=nV();return"injected"===e&&n?t.find(t=>t.id===e&&t.name===n):"injected"===e?t.find(n=>n.id===e&&n.name.includes("Injected")):t.find(n=>n.id===e)}nP.displayName="FitText";let nQ=e=>nX().find(n=>n.id===e)||null,nX=()=>{let e=nV(),n=rm();return e.map(e=>{var n,t;let o=Object.keys(ef).find(n=>-1!==n.split(",").map(e=>e.trim()).indexOf(e.id)),i={id:e.id,name:null!==(t=null!==(n=e.name)&&void 0!==n?n:e.id)&&void 0!==t?t:e.type,icon:(0,A.jsx)("img",{src:e.icon,alt:e.name,width:"100%",height:"100%"}),connector:e,iconShape:"squircle",isInstalled:"mock"===e.type||"injected"===e.type&&"metaMask"!==e.id||em(e.id)};if(o){let n=ef[o];return{...i,iconConnector:e.icon?(0,A.jsx)("img",{src:e.icon,alt:e.name,width:"100%",height:"100%"}):void 0,...n}}return i}).filter((e,n,t)=>t.findIndex(n=>n.id===e.id)===n).map(e=>{var t,o;return"walletConnect"===e.id?{...e,name:(null===(t=n.options)||void 0===t?void 0:t.walletConnectName)||e.name,shortName:(null===(o=n.options)||void 0===o?void 0:o.walletConnectName)||e.shortName}:e}).filter((e,n,t)=>!("coinbaseWalletSDK"===e.id&&t.find(e=>"com.coinbase.wallet"===e.id))).filter((e,n,t)=>!(("metaMaskSDK"===e.id||"metaMask"===e.id)&&t.find(e=>"io.metamask"===e.id||"io.metamask.mobile"===e.id))).sort((e,n)=>{let t=e.isInstalled&&ev(e.connector.type),o=n.isInstalled&&ev(n.connector.type);return t&&!o?-1:!t&&o?1:0}).sort((e,n)=>"walletConnect"===e.id?1:"walletConnect"===n.id?-1:0)},nJ=({isSignedIn:e})=>(0,A.jsxs)("div",{style:{position:"relative"},children:[e?(0,A.jsx)(nk,{style:{bottom:-1,right:-1}}):(0,A.jsx)("div",{style:{zIndex:2,position:"absolute",top:-2,right:-2,background:"#1A88F8",borderRadius:8,boxShadow:"0 0 0 2px var(--ck-body-background)",width:8,height:8}}),(0,A.jsxs)("svg",{"aria-hidden":"true",width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",style:{overflow:"visible"},children:[(0,A.jsx)("circle",{cx:"10",cy:"10",r:"9",stroke:"currentColor",strokeWidth:"2"}),(0,A.jsx)("path",{d:"M16.5 16.775C14.8618 15.0649 12.5552 14 10 14C7.44477 14 5.13825 15.0649 3.5 16.775",stroke:"currentColor",strokeWidth:"2"}),(0,A.jsx)("circle",{cx:"10",cy:"8",r:"3",stroke:"currentColor",strokeWidth:"2"})]})]}),nq=({...e})=>(0,A.jsx)("svg",{"aria-hidden":"true",width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M20 11C20 15.9706 15.9706 20 11 20C6.02944 20 2 15.9706 2 11C2 6.02944 6.02944 2 11 2C15.9706 2 20 6.02944 20 11ZM22 11C22 17.0751 17.0751 22 11 22C4.92487 22 0 17.0751 0 11C0 4.92487 4.92487 0 11 0C17.0751 0 22 4.92487 22 11ZM11.6445 12.7051C11.6445 13.1348 11.3223 13.4678 10.7744 13.4678C10.2266 13.4678 9.92578 13.1885 9.92578 12.6191V12.4795C9.92578 11.4268 10.4951 10.8574 11.2686 10.3203C12.2031 9.67578 12.665 9.32129 12.665 8.59082C12.665 7.76367 12.0205 7.21582 11.043 7.21582C10.3232 7.21582 9.80762 7.57031 9.45312 8.16113C9.38282 8.24242 9.32286 8.32101 9.2667 8.39461C9.04826 8.68087 8.88747 8.8916 8.40039 8.8916C8.0459 8.8916 7.66992 8.62305 7.66992 8.15039C7.66992 7.96777 7.70215 7.7959 7.75586 7.61328C8.05664 6.625 9.27051 5.75488 11.1182 5.75488C12.9336 5.75488 14.5234 6.71094 14.5234 8.50488C14.5234 9.7832 13.7822 10.417 12.7402 11.1045C11.999 11.5986 11.6445 11.9746 11.6445 12.5762V12.7051ZM11.9131 15.5625C11.9131 16.1855 11.376 16.6797 10.7529 16.6797C10.1299 16.6797 9.59277 16.1748 9.59277 15.5625C9.59277 14.9395 10.1191 14.4453 10.7529 14.4453C11.3867 14.4453 11.9131 14.9287 11.9131 15.5625Z",fill:"currentColor"})}),nK=({...e})=>(0,A.jsx)(O.P.svg,{width:14,height:14,viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,A.jsx)("path",{d:"M1 13L13 1M1 1L13 13",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round"})}),n$=({...e})=>(0,A.jsx)(O.P.svg,{width:9,height:16,viewBox:"0 0 9 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,A.jsx)("path",{d:"M8 1L1 8L8 15",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),n1={initial:{zIndex:2,opacity:0},animate:{opacity:1,scale:1,transition:{duration:.165,delay:.055,ease:[.26,.08,.25,1]}},exit:{zIndex:1,opacity:0,pointerEvents:"none",position:"absolute",left:["50%","50%"],x:["-50%","-50%"],transition:{duration:.22,ease:[.26,.08,.25,1]}}},n0=({open:e,pages:n,pageId:t,positionInside:o,inline:i,demo:r,onClose:a,onBack:c,onInfo:l})=>{var p,h,u,g,x,b,m,C,v,f,k,w;let y;let j=rm(),S=nu(),N=eg(),{isSignedIn:E,reset:L}=ny(),I=nQ(null===(p=j.connector)||void 0===p?void 0:p.id),_={name:null==I?void 0:I.name,shortName:null!==(h=null==I?void 0:I.shortName)&&void 0!==h?h:null==I?void 0:I.name,icon:null!==(u=null==I?void 0:I.iconConnector)&&void 0!==u?u:null==I?void 0:I.icon,iconShape:null!==(g=null==I?void 0:I.iconShape)&&void 0!==g?g:"circle",iconShouldShrink:null==I?void 0:I.iconShouldShrink},W=nD({CONNECTORNAME:null==_?void 0:_.name}),[T,z]=(0,Z.p)({timeout:160,preEnter:!0,mountOnEnter:!0,unmountOnExit:!0}),D=!("exited"===T||"unmounted"===T),R="preEnter"===T||"exiting"!==T,B=j.route===rg.CONNECTORS?0:j.route===rg.DOWNLOAD?2:1,H=nl(B,B);o||ns(D),nl(t,t),(0,M.useEffect)(()=>{z(e),e&&V(void 0)},[e]);let[U,G]=(0,M.useState)({width:void 0,height:void 0}),[P,V]=(0,M.useState)(void 0),Y=e=>{let n={width:null==e?void 0:e.offsetWidth,height:null==e?void 0:e.offsetHeight};G({width:`${null==n?void 0:n.width}px`,height:`${null==n?void 0:n.height}px`})},Q=(0,M.useCallback)(e=>{e&&(q.current=e,V(void 0!==P),clearTimeout(y),y=setTimeout(()=>V(!1),360),Y(e))},[e,P]),{chain:X}=(0,s.F)(),{switchChain:J}=(0,d.R)(),q=(0,M.useRef)(null);(0,M.useEffect)(()=>{q.current&&Y(q.current)},[X,J,N,E,j.options,j.resize]),(0,M.useEffect)(()=>{if(!D){G({width:void 0,height:void 0});return}let e=e=>{"Escape"===e.key&&a&&a()};return document.addEventListener("keydown",e),()=>{document.removeEventListener("keydown",e)}},[D,a]);let K={"--height":U.height,"--width":U.width},$=(0,A.jsx)(eW,{$useTheme:null!==(x=null==r?void 0:r.theme)&&void 0!==x?x:S.theme,$useMode:null!==(b=null==r?void 0:r.mode)&&void 0!==b?b:S.mode,$customTheme:null!==(m=null==r?void 0:r.customTheme)&&void 0!==m?m:S.customTheme,children:(0,A.jsxs)(e6,{role:"dialog",style:{pointerEvents:R?"auto":"none",position:o?"absolute":void 0},children:[!i&&(0,A.jsx)(eK,{$active:R,onClick:a,$blur:null===(C=j.options)||void 0===C?void 0:C.overlayBlur}),(0,A.jsxs)(no,{style:K,initial:!1,children:[(0,A.jsx)("div",{style:{pointerEvents:P?"all":"none",position:"absolute",top:0,bottom:0,left:"50%",transform:"translateX(-50%)",width:"var(--width)",zIndex:9,transition:"width 200ms ease"}}),(0,A.jsxs)(e3,{className:`${R&&"active"}`,children:[(0,A.jsx)(F.N,{initial:!1,children:(null===(v=j.options)||void 0===v?void 0:v.disclaimer)&&j.route===rg.CONNECTORS&&(0,A.jsx)(nr,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{delay:0,duration:.2,ease:[.25,.1,.25,1]},children:(0,A.jsx)(ni,{children:(0,A.jsx)("div",{children:null===(f=j.options)||void 0===f?void 0:f.disclaimer})})})}),(0,A.jsx)(F.N,{initial:!1,children:j.errorMessage&&(0,A.jsxs)(eD,{initial:{y:"10%",x:"-50%"},animate:{y:"-100%"},exit:{y:"100%"},transition:{duration:.2,ease:"easeInOut"},children:[(0,A.jsx)("span",{children:j.errorMessage}),(0,A.jsx)("div",{onClick:()=>j.displayError(null),style:{position:"absolute",right:24,top:24,cursor:"pointer"},children:(0,A.jsx)(nK,{})})]})}),(0,A.jsxs)(e5,{children:[a&&(0,A.jsx)(e7,{"aria-label":ex(W.close).toString(),onClick:a,children:(0,A.jsx)(nK,{})}),(0,A.jsx)("div",{style:{position:"absolute",top:23,left:20,width:32,height:32},children:(0,A.jsx)(F.N,{children:c?(0,A.jsx)(nn,{disabled:P,"aria-label":ex(W.back).toString(),onClick:c,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:N?0:.1,delay:N?.01:0},children:(0,A.jsx)(n$,{})},"backButton"):j.route===rg.PROFILE&&j.signInWithEthereum?(0,A.jsxs)(A.Fragment,{children:[!E&&!(null===(k=j.options)||void 0===k?void 0:k.hideTooltips)&&(0,A.jsx)(O.P.div,{style:{position:"absolute",inset:0,pointerEvents:"none"},initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1,transition:{delay:.5,duration:.2}},exit:{opacity:0,scale:.6,transition:{delay:0,duration:N?0:.1}},children:(0,A.jsx)(na,{children:W.signInWithEthereumScreen_tooltip})}),(0,A.jsx)(ne,{disabled:P,"aria-label":W.signInWithEthereumScreen_signedOut_heading,onClick:()=>{L(),j.setRoute(rg.SIGNINWITHETHEREUM)},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:N?0:.1,delay:N?.01:0},children:(0,A.jsx)(nJ,{isSignedIn:E})},"siweButton")]}):l&&!(null===(w=j.options)||void 0===w?void 0:w.hideQuestionMarkCTA)&&(0,A.jsx)(nt,{disabled:P,"aria-label":ex(W.moreInformation).toString(),onClick:l,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:N?0:.1,delay:N?.01:0},children:(0,A.jsx)(nq,{})},"infoButton")})})]}),(0,A.jsx)(eY,{children:(0,A.jsx)(F.N,{children:(0,A.jsx)(O.P.div,{style:{position:"absolute",top:0,bottom:0,left:52,right:52,display:"flex",justifyContent:"center"},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:N?0:.17,delay:N?.01:0},children:(0,A.jsx)(nP,{children:function(){var e;switch(j.route){case rg.ABOUT:return W.aboutScreen_heading;case rg.CONNECT:if(I&&!(!I.getWalletConnectDeeplink||I.isInstalled))return eb(null===(e=null==I?void 0:I.connector)||void 0===e?void 0:e.id)?W.scanScreen_heading:W.scanScreen_heading_withConnector;return null==_?void 0:_.name;case rg.CONNECTORS:return W.connectorsScreen_heading;case rg.MOBILECONNECTORS:return W.mobileConnectorsScreen_heading;case rg.DOWNLOAD:return W.downloadAppScreen_heading;case rg.ONBOARDING:return W.onboardingScreen_heading;case rg.PROFILE:return W.profileScreen_heading;case rg.SWITCHNETWORKS:return W.switchNetworkScreen_heading;case rg.SIGNINWITHETHEREUM:return E?W.signInWithEthereumScreen_signedIn_heading:W.signInWithEthereumScreen_signedOut_heading;default:return""}}()})},`${j.route}-${E?"signedIn":""}`)})}),(0,A.jsx)(e4,{children:Object.keys(n).map(e=>{let i=n[e];return(0,A.jsx)(n2,{open:e===t,initial:!o&&"entered"!==T,enterAnim:e===t?B>H?"active-scale-up":"active":"",exitAnim:e!==t?B<H?"exit-scale-down":"exit":"",children:(0,A.jsx)(e8,{ref:Q,style:{pointerEvents:e===t&&R?"auto":"none"},children:i},`inner-${e}`)},e)})})]})]})]})});return(0,A.jsx)(A.Fragment,{children:D&&(0,A.jsx)(A.Fragment,{children:o?$:(0,A.jsx)(A.Fragment,{children:(0,A.jsx)(eT,{children:(0,A.jsx)(nd,{children:$})})})})})},n2=({children:e,open:n,initial:t,prevDepth:o,currentDepth:i,enterAnim:r,exitAnim:a})=>{let[c,s]=(0,Z.p)({timeout:400,preEnter:!0,initialEntered:n,mountOnEnter:!0,unmountOnExit:!0});return((0,M.useEffect)(()=>{s(n)},[n]),"exited"===c||"unmounted"===c)?null:(0,A.jsx)(e9,{className:`${"preEnter"===c||"exiting"!==c?r:a}`,style:{animationDuration:t?"0ms":void 0,animationDelay:t?"0ms":void 0},children:e})},n3=({children:e})=>{let n=nD();return(0,A.jsx)(eV,{children:(0,A.jsx)("span",{children:null!=e?e:n.or})})},n5=ey(O.P.div)`
  position: relative;
...
`,n8=ey(O.P.div)`
  ...
  animation: ${n9} 1000ms 100ms ease both;
  @media only screen and (max-width: ${ez.mobileWidth}px) {
    animation: none;
  }
`,n6=(0,T.i7)`
...
`,ta=ey(O.P.div)`
  ...
  animation: ${n6} 750ms cubic-bezier(0.19, 1, 0.22, 1) both;
  ...
  &:nth-child(1){ ${tr}{ animation-delay:0ms; } }
  &:nth-child(2){ ${tr}{ animation-delay:-600ms; } }
  &:nth-child(3){ ${tr}{ animation-delay:-1200ms; } }
  &:nth-child(4){ ${tr}{ animation-delay:-1800ms; } }
  &:nth-child(5){ ${tr}{ animation-delay:-2400ms; } }

  &:nth-child(1){ ${to}{ animation-delay:-200ms; } }
  &:nth-child(2){ ${to}{ animation-delay:-600ms; } }
  &:nth-child(3){ ${to}{ animation-delay:-800ms; } }
  &:nth-child(4){ ${to}{ animation-delay:-300ms; } }
  &:nth-child(5){ ${to}{ animation-delay:-3200ms; } }
...
`,tx=ey.button`
  ...
  @media only screen and (min-width: ${ez.mobileWidth+1}px) {
    &:hover,
    &:focus-visible {
...
`,tv=ey(O.P.div)`
  ...
  svg {
    display: block;
    position: relative;
    animation: ${tC} 1s ease-in-out infinite;
  }
`,tf={duration:.4,ease:[.175,.885,.32,.98]},tk=()=>(0,A.jsx)(tv,{initial:{opacity:0,rotate:180},animate:{opacity:1,rotate:0},exit:{position:"absolute",opacity:0,rotate:-180,transition:{...tf}},transition:{...tf,delay:.2},children:(0,A.jsxs)("svg",{width:"18",height:"18",viewBox:"0 0 18 18",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("circle",{cx:"9",cy:"9",r:"7",stroke:"currentColor",strokeOpacity:"0.1",strokeWidth:"2.5"}),(0,A.jsx)("path",{d:"M16 9C16 5.13401 12.866 2 9 2",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round"})]})}),tw={duration:.4,ease:[.175,.885,.32,.98]},ty=({children:e,variant:n="secondary",disabled:t,icon:o,iconPosition:i="left",roundedIcon:r,waiting:a,arrow:c,download:s,href:d,style:l,onClick:p})=>{let h="string"==typeof e?e:ex(e).join(""),u="string"==typeof d?d:ex(d).join("");return(0,A.jsx)(tx,{as:d?"a":void 0,onClick:e=>{!t&&p&&p(e)},href:u,target:d&&"_blank",rel:d&&"noopener noreferrer",disabled:t,$variant:n,style:l,children:(0,A.jsxs)(F.N,{initial:!1,children:[(0,A.jsxs)(tg,{initial:{opacity:0,y:-10},animate:{opacity:1,y:-1},exit:{position:"absolute",opacity:0,y:10,transition:{...tw}},transition:{...tw,delay:.2},children:[o&&"left"===i&&(0,A.jsx)(tm,{$rounded:r,children:o}),s&&(0,A.jsx)(th,{children:(0,A.jsx)(tu,{children:(0,A.jsxs)(td,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)(tp,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"}),(0,A.jsx)(tl,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"})]})})}),(0,A.jsx)(tb,{style:{paddingLeft:c?6:0},children:(0,A.jsx)(nP,{children:e})}),o&&"right"===i&&(0,A.jsx)(tm,{$rounded:r,children:o}),c&&(0,A.jsxs)(td,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)(tp,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"2",strokeLinecap:"round"}),(0,A.jsx)(tl,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"2",strokeLinecap:"round"})]})]},h),a&&(0,A.jsx)(ts,{children:(0,A.jsx)(tk,{})})]})})},tj=()=>{var e,n;let t=rm(),o=nD({}),i=null!==(n=null===(e=t.options)||void 0===e?void 0:e.walletOnboardingUrl)&&void 0!==n?n:o.onboardingScreen_ctaUrl;return(0,A.jsxs)(eP,{children:[(0,A.jsxs)(n5,{children:[(0,A.jsxs)(n4,{children:[(0,A.jsx)(ta,{children:(0,A.jsx)(n7,{children:(0,A.jsx)(te,{children:(0,A.jsx)(to,{children:(0,A.jsx)(tr,{children:(0,A.jsx)(tn,{children:(0,A.jsx)(er.Coinbase,{background:!0})})})})})})}),(0,A.jsx)(ta,{children:(0,A.jsx)(n7,{children:(0,A.jsx)(te,{children:(0,A.jsx)(to,{children:(0,A.jsx)(tr,{children:(0,A.jsx)(tn,{children:(0,A.jsx)(er.MetaMask,{background:!0})})})})})})}),(0,A.jsx)(ta,{children:(0,A.jsx)(n7,{children:(0,A.jsx)(te,{children:(0,A.jsx)(to,{children:(0,A.jsx)(tr,{children:(0,A.jsx)(tn,{children:(0,A.jsx)(er.Trust,{})})})})})})}),(0,A.jsx)(ta,{children:(0,A.jsx)(n7,{children:(0,A.jsx)(te,{children:(0,A.jsx)(to,{children:(0,A.jsx)(tr,{children:(0,A.jsx)(tn,{children:(0,A.jsx)(er.Argent,{})})})})})})}),(0,A.jsx)(ta,{children:(0,A.jsx)(n7,{children:(0,A.jsx)(te,{children:(0,A.jsx)(to,{children:(0,A.jsx)(tr,{children:(0,A.jsx)(tn,{children:(0,A.jsx)(er.ImToken,{})})})})})})})]}),(0,A.jsx)(n8,{children:tc})]}),(0,A.jsxs)(eX,{style:{paddingBottom:18},children:[(0,A.jsx)(eJ,{$small:!0,children:o.onboardingScreen_h1}),(0,A.jsx)(eq,{children:o.onboardingScreen_p})]}),(0,A.jsx)(ty,{href:i,arrow:!0,children:o.onboardingScreen_ctaText})]})},tS=ey.div`
  pointer-events: none;
  user-select: none;
  height: ${208}px;
  padding: 0 0 12px;
...
`,t_=ey.button`
  ...
  ${e=>e.$active?(0,T.AH)`
        ...
        `}
`,tO={scale:[.9,1.25,1.6],opacity:[0,.11,0]},tF={ease:"linear",duration:2,repeat:1/0},tW=ey.div`
  position: absolute;
  left: 50%;
  top: 50%;
...
`,tz=ey(O.P.div)`
  ...
  overflow: hidden;
  border-radius: 100%;
  animation: ${tT} 16s linear infinite;
`,tD=ey(O.P.div)`
  overflow: hidden;
...
`,tB=ey(O.P.div)`
  ...
  justify-content: center;
  border-radius: 50%;
`,tH=(0,A.jsxs)("svg",{width:"34",height:"34",viewBox:"0 0 34 34",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{d:"M17 34C26.3 34 34 26.2833 34 17C34 7.7 26.2833 0 16.9833 0C7.7 0 0 7.7 0 17C0 26.2833 7.71667 34 17 34ZM9.83333 25.6833C8.68333 26.2333 7.8 25.3333 8.33333 24.2L13.1667 14.3333C13.45 13.75 13.8167 13.3833 14.35 13.1333L24.1833 8.33333C25.4 7.75 26.25 8.65 25.6833 9.81667L20.8833 19.6667C20.6167 20.2 20.2333 20.6 19.6833 20.85L9.83333 25.6833ZM17.0167 19.1333C18.1833 19.1333 19.1333 18.1833 19.1333 17.0167C19.1333 15.85 18.1833 14.9167 17.0167 14.9167C15.8667 14.9167 14.9167 15.85 14.9167 17.0167C14.9167 18.1833 15.8667 19.1333 17.0167 19.1333Z",fill:"var(--ck-graphic-compass-color, var(--ck-body-color))"}),(0,A.jsx)("path",{d:"M17 34C26.3 34 34 26.2833 34 17C34 7.7 26.2833 0 16.9833 0C7.7 0 0 7.7 0 17C0 26.2833 7.71667 34 17 34ZM9.83333 25.6833C8.68333 26.2333 7.8 25.3333 8.33333 24.2L13.1667 14.3333C13.45 13.75 13.8167 13.3833 14.35 13.1333L24.1833 8.33333C25.4 7.75 26.25 8.65 25.6833 9.81667L20.8833 19.6667C20.6167 20.2 20.2333 20.6 19.6833 20.85L9.83333 25.6833ZM17.0167 19.1333C18.1833 19.1333 19.1333 18.1833 19.1333 17.0167C19.1333 15.85 18.1833 14.9167 17.0167 14.9167C15.8667 14.9167 14.9167 15.85 14.9167 17.0167C14.9167 18.1833 15.8667 19.1333 17.0167 19.1333Z",fill:"url(#ck-compass-gradient)"}),(0,A.jsx)("defs",{children:(0,A.jsxs)("linearGradient",{id:"ck-compass-gradient",x1:"17",y1:"0",x2:"17",y2:"34",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"rgba(0,0,0,0)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"rgba(0,0,0,0.05)"})]})})]}),tU=({inverted:e=!1})=>(0,A.jsxs)("svg",{width:"58",height:"50",viewBox:"0 0 58 50",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M57.9332 20.3335V42.1113C57.9332 46.4069 54.451 49.8891 50.1555 49.8891H8.15546C3.85991 49.8891 0.377686 46.4069 0.377686 42.1113V25.0002V7.8891C0.377686 3.59355 3.85991 0.111328 8.15546 0.111328H47.0444C48.7626 0.111328 50.1555 1.50422 50.1555 3.22244C50.1555 4.94066 48.7626 6.33355 47.0443 6.33355H9.71102C7.9928 6.33355 6.59991 7.72644 6.59991 9.44466C6.59991 11.1629 7.9928 12.5558 9.71102 12.5558H50.1555C54.451 12.5558 57.9332 16.038 57.9332 20.3335ZM46.2667 34.3337C48.4145 34.3337 50.1556 32.5926 50.1556 30.4448C50.1556 28.297 48.4145 26.5559 46.2667 26.5559C44.1189 26.5559 42.3778 28.297 42.3778 30.4448C42.3778 32.5926 44.1189 34.3337 46.2667 34.3337Z",fill:e?"var(--ck-graphic-primary-color, var(--ck-body-background))":"var(--ck-graphic-primary-color, var(--ck-body-color))"}),(0,A.jsx)("defs",{children:(0,A.jsxs)("linearGradient",{id:"paint0_linear_2501_7732",x1:"29.1555",y1:"0.111328",x2:"29.1555",y2:"49.8891",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:e?"var(--ck-body-color-muted)":"var(--ck-body-background-transparent, transparent)"}),(0,A.jsx)("stop",{offset:"1",stopColor:e?"var(--ck-body-color)":"var(--ck-body-background)"})]})})]}),tZ=(0,A.jsx)("svg",{width:"41",height:"41",viewBox:"0 0 41 41",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,A.jsx)("path",{d:"M35.4446 0.839914L2.14484 10.7065C0.0395033 11.3303 -0.632966 13.9786 0.919705 15.5313L7.9624 22.574C9.47585 24.0874 11.8661 24.273 13.5951 23.0114L25.2866 14.4797C25.5558 14.2832 25.9281 14.3121 26.1638 14.5478C26.3998 14.7838 26.4285 15.1567 26.2313 15.426L17.6874 27.0937C16.4213 28.8228 16.6052 31.2168 18.1206 32.7322L25.1811 39.7926C26.7337 41.3453 29.382 40.6728 30.0058 38.5675L39.8724 5.2677C40.6753 2.55794 38.1544 0.037024 35.4446 0.839914Z",fill:"var(--ck-graphic-secondary-color, white)"})}),tG=(0,A.jsx)("svg",{width:"38",height:"44",viewBox:"0 0 38 44",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M19 0.875C21.4853 0.875 23.5 2.88972 23.5 5.375V27.761L30.068 21.193C31.8254 19.4357 34.6746 19.4357 36.432 21.193C38.1893 22.9504 38.1893 25.7996 36.432 27.557L22.182 41.807C20.4246 43.5643 17.5754 43.5643 15.818 41.807L1.56802 27.557C-0.18934 25.7996 -0.18934 22.9504 1.56802 21.193C3.32538 19.4357 6.17462 19.4357 7.93198 21.193L14.5 27.761V5.375C14.5 2.88972 16.5147 0.875 19 0.875Z",fill:"var(--ck-graphic-secondary-color, white)"})}),tP=({...e})=>{var n;let t=null!==(n=null==e?void 0:e.id)&&void 0!==n?n:"";return(0,A.jsxs)("svg",{...e,width:"81",height:"81",viewBox:"0 0 81 81",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M81 27C81 41.9117 68.9117 54 54 54C51.2722 54 48.6389 53.5955 46.1568 52.8432L36 63H27V72H18V81H4.5C2.01472 81 0 78.9853 0 76.5V64.864C0 63.6705 0.474103 62.5259 1.31802 61.682L28.1568 34.8432C27.4045 32.3611 27 29.7278 27 27C27 12.0883 39.0883 0 54 0C68.9117 0 81 12.0883 81 27ZM60.75 25.875C63.8566 25.875 66.375 23.3566 66.375 20.25C66.375 17.1434 63.8566 14.625 60.75 14.625C57.6434 14.625 55.125 17.1434 55.125 20.25C55.125 23.3566 57.6434 25.875 60.75 25.875Z",fill:`url(#${t}paint0_linear_2509_6177)`}),(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M81 27C81 41.9117 68.9117 54 54 54C51.2722 54 48.6389 53.5955 46.1568 52.8432L36 63H27V72H18V81H4.5C2.01472 81 0 78.9853 0 76.5V64.864C0 63.6705 0.474103 62.5259 1.31802 61.682L28.1568 34.8432C27.4045 32.3611 27 29.7278 27 27C27 12.0883 39.0883 0 54 0C68.9117 0 81 12.0883 81 27ZM60.75 25.875C63.8566 25.875 66.375 23.3566 66.375 20.25C66.375 17.1434 63.8566 14.625 60.75 14.625C57.6434 14.625 55.125 17.1434 55.125 20.25C55.125 23.3566 57.6434 25.875 60.75 25.875Z",fill:`url(#${t}paint1_radial_2509_6177)`,fillOpacity:"0.2"}),(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M44.5658 51.2522C45.1527 50.6653 46.0151 50.4492 46.8095 50.6899C49.0823 51.3788 51.4958 51.75 54 51.75C67.6691 51.75 78.75 40.669 78.75 27C78.75 13.331 67.6691 2.25 54 2.25C40.331 2.25 29.25 13.331 29.25 27C29.25 29.5042 29.6212 31.9177 30.3101 34.1905C30.5508 34.9849 30.3347 35.8473 29.7478 36.4342L2.90901 63.273C2.48705 63.6949 2.25 64.2672 2.25 64.864V76.5C2.25 77.7426 3.25736 78.75 4.5 78.75H15.75V72C15.75 70.7574 16.7574 69.75 18 69.75H24.75V63C24.75 61.7574 25.7574 60.75 27 60.75H35.068L44.5658 51.2522ZM36 63H27V72H18V81H4.5C2.01472 81 0 78.9853 0 76.5V64.864C0 63.6705 0.474103 62.5259 1.31802 61.682L28.1568 34.8432C27.4045 32.3611 27 29.7278 27 27C27 12.0883 39.0883 0 54 0C68.9117 0 81 12.0883 81 27C81 41.9117 68.9117 54 54 54C51.2722 54 48.6389 53.5955 46.1568 52.8432L36 63ZM68.625 20.25C68.625 24.5992 65.0992 28.125 60.75 28.125C56.4008 28.125 52.875 24.5992 52.875 20.25C52.875 15.9008 56.4008 12.375 60.75 12.375C65.0992 12.375 68.625 15.9008 68.625 20.25ZM66.375 20.25C66.375 23.3566 63.8566 25.875 60.75 25.875C57.6434 25.875 55.125 23.3566 55.125 20.25C55.125 17.1434 57.6434 14.625 60.75 14.625C63.8566 14.625 66.375 17.1434 66.375 20.25Z",fill:"black",fillOpacity:"0.1"}),(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M33.4205 47.5795C33.8598 48.0188 33.8598 48.7312 33.4205 49.1705L3.0455 79.5455C2.60616 79.9848 1.89384 79.9848 1.4545 79.5455C1.01517 79.1062 1.01517 78.3938 1.4545 77.9545L31.8295 47.5795C32.2688 47.1402 32.9812 47.1402 33.4205 47.5795Z",fill:"#A5A9AD"}),(0,A.jsxs)("defs",{children:[(0,A.jsxs)("linearGradient",{id:`${t}paint0_linear_2509_6177`,x1:"72",y1:"5.625",x2:"2.25",y2:"78.75",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"#D4DFE6"}),(0,A.jsx)("stop",{offset:"0.0967282",stopColor:"#C6CACD"}),(0,A.jsx)("stop",{offset:"0.526645",stopColor:"#BDBAC4"}),(0,A.jsx)("stop",{offset:"1",stopColor:"#939CA1"})]}),(0,A.jsxs)("radialGradient",{id:`${t}paint1_radial_2509_6177`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(52.875 12.375) rotate(93.2705) scale(39.4392)",children:[(0,A.jsx)("stop",{stopColor:"white"}),(0,A.jsx)("stop",{offset:"1",stopColor:"white"})]})]})]})},tV=(0,A.jsxs)("svg",{width:"131",height:"14",viewBox:"0 0 131 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{d:"M5.74805 13.2549C8.86816 13.2549 10.7227 10.6973 10.7227 6.63672C10.7227 2.57617 8.85059 0.0625 5.74805 0.0625C2.63672 0.0625 0.755859 2.59375 0.755859 6.64551C0.755859 10.7148 2.61914 13.2549 5.74805 13.2549ZM5.74805 11.4004C4.02539 11.4004 3.04102 9.64258 3.04102 6.63672C3.04102 3.68359 4.04297 1.91699 5.74805 1.91699C7.44434 1.91699 8.4375 3.6748 8.4375 6.64551C8.4375 9.65137 7.46191 11.4004 5.74805 11.4004Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M13.0869 13.1758C13.4561 13.1758 13.6934 13.0439 13.9658 12.6221L15.9697 9.66016H16.0137L18.0264 12.6572C18.2549 13.0088 18.4922 13.1758 18.8965 13.1758C19.4854 13.1758 19.9424 12.7891 19.9424 12.209C19.9424 11.9805 19.8633 11.7695 19.7051 11.541L17.376 8.28906L19.6963 5.16016C19.8896 4.90527 19.9688 4.68555 19.9688 4.43066C19.9688 3.88574 19.5381 3.49902 18.9229 3.49902C18.5361 3.49902 18.2988 3.6748 18.0176 4.10547L16.1191 6.95312H16.0752L14.1328 4.08789C13.8516 3.64844 13.6318 3.49902 13.2012 3.49902C12.6035 3.49902 12.1465 3.91211 12.1465 4.44824C12.1465 4.70312 12.2256 4.92285 12.3838 5.13379L14.7129 8.35059L12.3486 11.5498C12.1641 11.8135 12.0762 12.0156 12.0762 12.2705C12.0762 12.7979 12.498 13.1758 13.0869 13.1758Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M26.2441 13.2549C29.1445 13.2549 31.1924 11.7432 31.1924 9.57227C31.1924 7.9375 30.0146 6.68066 28.3184 6.3291V6.27637C29.7773 5.87207 30.7178 4.7998 30.7178 3.45508C30.7178 1.48633 28.8633 0.0625 26.2441 0.0625C23.625 0.0625 21.7617 1.49512 21.7617 3.44629C21.7617 4.80859 22.7109 5.88965 24.1699 6.27637V6.3291C22.4736 6.67188 21.3047 7.92871 21.3047 9.57227C21.3047 11.7344 23.335 13.2549 26.2441 13.2549ZM26.2441 5.55566C24.9258 5.55566 24.0029 4.78223 24.0029 3.6748C24.0029 2.55859 24.9258 1.77637 26.2441 1.77637C27.5537 1.77637 28.4854 2.5498 28.4854 3.6748C28.4854 4.78223 27.5537 5.55566 26.2441 5.55566ZM26.2441 11.5234C24.7236 11.5234 23.6514 10.6357 23.6514 9.40527C23.6514 8.1748 24.7236 7.28711 26.2441 7.28711C27.7646 7.28711 28.8369 8.16602 28.8369 9.40527C28.8369 10.6357 27.7646 11.5234 26.2441 11.5234Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M36.3164 13.1494C37.7578 13.1494 38.7598 12.4199 39.208 11.3477H39.252V12.0771C39.252 12.7891 39.7266 13.1758 40.3594 13.1758C40.9922 13.1758 41.4404 12.7803 41.4404 12.0771V1.29297C41.4404 0.554688 40.9834 0.141602 40.3418 0.141602C39.7002 0.141602 39.252 0.554688 39.252 1.29297V5.24805H39.1992C38.707 4.21973 37.6523 3.52539 36.3164 3.52539C33.9697 3.52539 32.4492 5.38867 32.4492 8.33301C32.4492 11.2949 33.9697 13.1494 36.3164 13.1494ZM36.9756 11.3564C35.5605 11.3564 34.6904 10.1963 34.6904 8.3418C34.6904 6.49609 35.5693 5.32715 36.9756 5.32715C38.3555 5.32715 39.2607 6.51367 39.2607 8.3418C39.2607 10.1875 38.3555 11.3564 36.9756 11.3564Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M44.0508 13.1494C44.6396 13.1494 44.9736 12.8594 45.1846 12.1738L46.0195 9.76562H50.7568L51.5918 12.1914C51.7939 12.8682 52.1367 13.1494 52.752 13.1494C53.4111 13.1494 53.8857 12.7188 53.8857 12.1035C53.8857 11.9014 53.8418 11.6992 53.7363 11.4092L50.0449 1.38965C49.7285 0.537109 49.2188 0.167969 48.3838 0.167969C47.5576 0.167969 47.0479 0.554688 46.7402 1.39844L43.0576 11.4092C42.9521 11.6816 42.9082 11.9277 42.9082 12.1035C42.9082 12.7451 43.3564 13.1494 44.0508 13.1494ZM46.5557 7.97266L48.3398 2.55859H48.4014L50.2031 7.97266H46.5557Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M60.1172 13.2549C62.8594 13.2549 64.8545 11.4004 64.8545 8.8252C64.8545 6.42578 63.1406 4.66797 60.6973 4.66797C58.9746 4.66797 57.709 5.54688 57.208 6.71582H57.1641V6.58398C57.208 3.66602 58.2275 1.89941 60.1436 1.89941C61.084 1.89941 61.7607 2.26855 62.3496 3.07715C62.7012 3.52539 62.9824 3.73633 63.4307 3.73633C64.0283 3.73633 64.3975 3.34082 64.3975 2.82227C64.3975 2.57617 64.3359 2.35645 64.1953 2.10156C63.5625 0.897461 62.0859 0.0537109 60.1523 0.0537109C56.9268 0.0537109 54.9932 2.57617 54.9932 6.80371C54.9932 8.24512 55.2305 9.45801 55.6963 10.4336C56.5752 12.2881 58.1396 13.2549 60.1172 13.2549ZM60.082 11.4092C58.667 11.4092 57.5508 10.293 57.5508 8.86914C57.5508 7.4541 58.6494 6.41699 60.1084 6.41699C61.5674 6.41699 62.6309 7.4541 62.6221 8.91309C62.6221 10.3018 61.4971 11.4092 60.082 11.4092Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M68.1328 8.83398C68.8447 8.83398 69.416 8.27148 69.416 7.55078C69.416 6.83008 68.8447 6.25879 68.1328 6.25879C67.4121 6.25879 66.8408 6.83008 66.8408 7.55078C66.8408 8.27148 67.4121 8.83398 68.1328 8.83398Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M73.3359 8.83398C74.0479 8.83398 74.6191 8.27148 74.6191 7.55078C74.6191 6.83008 74.0479 6.25879 73.3359 6.25879C72.6152 6.25879 72.0439 6.83008 72.0439 7.55078C72.0439 8.27148 72.6152 8.83398 73.3359 8.83398Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M78.5391 8.83398C79.251 8.83398 79.8223 8.27148 79.8223 7.55078C79.8223 6.83008 79.251 6.25879 78.5391 6.25879C77.8184 6.25879 77.2471 6.83008 77.2471 7.55078C77.2471 8.27148 77.8184 8.83398 78.5391 8.83398Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M83.7422 8.83398C84.4541 8.83398 85.0254 8.27148 85.0254 7.55078C85.0254 6.83008 84.4541 6.25879 83.7422 6.25879C83.0215 6.25879 82.4502 6.83008 82.4502 7.55078C82.4502 8.27148 83.0215 8.83398 83.7422 8.83398Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M92.2148 13.2549C94.957 13.2549 96.9521 11.4004 96.9521 8.8252C96.9521 6.42578 95.2383 4.66797 92.7949 4.66797C91.0723 4.66797 89.8066 5.54688 89.3057 6.71582H89.2617V6.58398C89.3057 3.66602 90.3252 1.89941 92.2412 1.89941C93.1816 1.89941 93.8584 2.26855 94.4473 3.07715C94.7988 3.52539 95.0801 3.73633 95.5283 3.73633C96.126 3.73633 96.4951 3.34082 96.4951 2.82227C96.4951 2.57617 96.4336 2.35645 96.293 2.10156C95.6602 0.897461 94.1836 0.0537109 92.25 0.0537109C89.0244 0.0537109 87.0908 2.57617 87.0908 6.80371C87.0908 8.24512 87.3281 9.45801 87.7939 10.4336C88.6729 12.2881 90.2373 13.2549 92.2148 13.2549ZM92.1797 11.4092C90.7646 11.4092 89.6484 10.293 89.6484 8.86914C89.6484 7.4541 90.7471 6.41699 92.2061 6.41699C93.665 6.41699 94.7285 7.4541 94.7197 8.91309C94.7197 10.3018 93.5947 11.4092 92.1797 11.4092Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M103.377 13.2549C106.497 13.2549 108.352 10.6973 108.352 6.63672C108.352 2.57617 106.479 0.0625 103.377 0.0625C100.266 0.0625 98.3848 2.59375 98.3848 6.64551C98.3848 10.7148 100.248 13.2549 103.377 13.2549ZM103.377 11.4004C101.654 11.4004 100.67 9.64258 100.67 6.63672C100.67 3.68359 101.672 1.91699 103.377 1.91699C105.073 1.91699 106.066 3.6748 106.066 6.64551C106.066 9.65137 105.091 11.4004 103.377 11.4004Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M117.167 13.1758C117.8 13.1758 118.248 12.7715 118.248 12.0596V10.5654H119.127C119.733 10.5654 120.094 10.1875 120.094 9.63379C120.094 9.08887 119.733 8.70215 119.136 8.70215H118.248V1.81152C118.248 0.756836 117.554 0.141602 116.385 0.141602C115.453 0.141602 114.899 0.52832 114.073 1.75879C112.553 3.99121 111.111 6.16211 110.224 7.75293C109.872 8.38574 109.731 8.79883 109.731 9.29102C109.731 10.0469 110.268 10.5654 111.085 10.5654H116.086V12.0596C116.086 12.7715 116.543 13.1758 117.167 13.1758ZM116.121 8.75488H111.788V8.69336C112.816 6.82129 114.073 4.92285 116.086 2.04004H116.121V8.75488Z",fill:"var(--ck-body-color)"}),(0,A.jsx)("path",{d:"M126.105 13.2549C128.918 13.2549 130.869 11.4355 130.869 8.78125C130.869 6.35547 129.138 4.6416 126.712 4.6416C125.438 4.6416 124.392 5.13379 123.855 5.9248H123.812L124.146 2.17188H129.27C129.85 2.17188 130.228 1.80273 130.228 1.24023C130.228 0.686523 129.85 0.317383 129.27 0.317383H123.803C122.81 0.317383 122.3 0.72168 122.221 1.72363L121.816 6.51367C121.808 6.56641 121.808 6.60156 121.808 6.6543C121.79 7.26953 122.15 7.78809 122.88 7.78809C123.398 7.78809 123.618 7.67383 124.146 7.14648C124.629 6.67188 125.323 6.34668 126.123 6.34668C127.617 6.34668 128.681 7.38379 128.681 8.84277C128.681 10.3457 127.617 11.4092 126.114 11.4092C124.893 11.4092 124.049 10.8027 123.618 9.77441C123.381 9.30859 123.091 9.12402 122.616 9.12402C122.019 9.12402 121.641 9.49316 121.641 10.082C121.641 10.4072 121.72 10.6709 121.843 10.9434C122.467 12.3232 124.154 13.2549 126.105 13.2549Z",fill:"var(--ck-body-color)"})]}),tY=({layoutId:e})=>(0,A.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"},children:[(0,A.jsx)(O.P.div,{initial:{rotate:90,scale:.2,x:"100%"},animate:{rotate:0,scale:1,x:0},exit:{rotate:40,scale:.1,x:"70%"},style:{zIndex:4,position:"relative",display:"flex",alignItems:"center",justifyContent:"center",width:76,height:76,background:"var(--ck-graphic-secondary-background, #6366F1)",borderRadius:"50%",boxShadow:"var(--ck-graphic-secondary-box-shadow, 0px 2px 10px rgba(99, 102, 241, 0.3))"},children:tG}),(0,A.jsx)(tR,{layoutId:e,style:{position:"relative",zIndex:10,margin:"0 -8px",width:112,height:112},children:(0,A.jsxs)(tB,{style:{background:"var(--ck-graphic-primary-background, var(--ck-body-background))",boxShadow:"var(--ck-graphic-primary-box-shadow, 0px 3px 15px rgba(0, 0, 0, 0.1))"},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:[(0,A.jsx)(tD,{}),(0,A.jsx)(O.P.div,{style:{zIndex:2,position:"relative"},children:(0,A.jsx)(tU,{})})]},"SlideOneInner")},e),(0,A.jsx)(O.P.div,{initial:{rotate:-90,scale:.2,x:"-100%"},animate:{rotate:0,scale:1,x:0},exit:{rotate:-40,scale:.1,x:"-70%"},style:{zIndex:4,position:"relative",width:76,height:76,background:"var(--ck-graphic-secondary-background, #3897FB)",borderRadius:"50%",boxShadow:"var(--ck-graphic-secondary-box-shadow, 0px 2px 10px rgba(56, 151, 251, 0.3))"},children:(0,A.jsx)(tW,{children:(0,A.jsx)("div",{style:{position:"relative",left:-2,top:3},children:tZ})})})]}),tQ=({layoutId:e})=>(0,A.jsx)(A.Fragment,{children:(0,A.jsxs)("div",{style:{position:"relative",left:-14},children:[(0,A.jsx)(tR,{layoutId:e,style:{zIndex:10,position:"absolute",left:15,top:12,width:32,height:32},children:(0,A.jsx)(tB,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},style:{background:"var(--ck-graphic-primary-background, var(--ck-body-background))",boxShadow:"var(--ck-graphic-primary-box-shadow, 0px 2px 5px rgba(37, 41, 46, 0.16))"},children:(0,A.jsx)(tW,{children:(0,A.jsx)(tU,{})})},"SlideTwoInner")},e),(0,A.jsxs)(O.P.div,{initial:{scale:.2},animate:{scale:1},exit:{scale:.2},style:{zIndex:7,position:"relative",display:"flex",alignItems:"center",padding:"21px 56px",paddingRight:52,background:"var(--ck-graphic-primary-background, var(--ck-body-background))",boxShadow:"var(--ck-graphic-primary-box-shadow, 0px 2px 9px rgba(0, 0, 0, 0.07))",borderRadius:"var(--ck-border-radius, 16px)"},children:[(0,A.jsx)(tD,{}),(0,A.jsx)("div",{style:{position:"relative",zIndex:2,top:1,left:1},children:tV})]}),(0,A.jsx)(O.P.div,{style:{zIndex:8,position:"absolute",top:-16,right:-28},initial:{rotate:90,x:-70,scale:.4},animate:{rotate:0,x:0,scale:1},exit:{rotate:0,x:-70,scale:.4},children:(0,A.jsx)(tP,{id:e})})]})}),tX=({layoutId:e})=>{let n=Math.random();return(0,A.jsx)(A.Fragment,{children:(0,A.jsxs)(O.P.div,{style:{position:"relative"},children:[(0,A.jsxs)(tR,{layoutId:e,initial:{rotate:80},style:{zIndex:10,position:"relative",width:128,height:128},children:[(0,A.jsx)(tB,{initial:{opacity:0,rotate:100},animate:{opacity:1},exit:{opacity:0},style:{overflow:"hidden",background:`var(--ck-graphic-globe-background, radial-gradient(
              82.42% 82.42% at 50% 86.72%,
              rgba(255, 255, 255, 0.2) 0%,
              rgba(0, 0, 0, 0) 100%
            ),
            linear-gradient(180deg, #3897FB 0%, #5004F1 100%))`,boxShadow:"var(--ck-graphic-globe-box-shadow, 0px -6px 20px rgba(56, 151, 251, 0.23))"},children:(0,A.jsx)(tz,{style:e?void 0:{animationPlayState:"paused"},children:(0,A.jsxs)("svg",{width:"128",height:"128",viewBox:"0 0 128 128",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsxs)("g",{children:[(0,A.jsx)("circle",{cx:"30",cy:"141",r:"64",stroke:`url(#networkRadialA-${n})`,strokeWidth:"3"}),(0,A.jsx)("circle",{cx:"78.8515",cy:"131.123",r:"54.1005",transform:"rotate(-37.4016 78.8515 131.123)",stroke:`url(#networkRadialB-${n})`,strokeWidth:"3"}),(0,A.jsx)("circle",{cx:"63.6053",cy:"2.12794",r:"50.8338",transform:"rotate(134.702 63.6053 2.12794)",stroke:`url(#networkRadialC-${n})`,strokeWidth:"3"}),(0,A.jsx)("circle",{cx:"126.658",cy:"56.6577",r:"50.3433",transform:"rotate(-105 126.658 56.6577)",stroke:`url(#networkRadialD-${n})`,strokeWidth:"3"}),(0,A.jsx)("circle",{cx:"13.6619",cy:"18.9603",r:"46.0247",transform:"rotate(107.362 13.6619 18.9603)",stroke:`url(#networkRadialE-${n})`,strokeWidth:"3"})]}),(0,A.jsxs)("defs",{children:[(0,A.jsxs)("radialGradient",{id:`networkRadialA-${n}`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(60.5 84) rotate(104.668) scale(77.0097)",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-graphic-globe-lines, white)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-globe-lines, white)",stopOpacity:"0"})]}),(0,A.jsxs)("radialGradient",{id:`networkRadialB-${n}`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(96.1805 81.6717) rotate(97.125) scale(64.7443)",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-graphic-globe-lines, white)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-globe-lines, white)",stopOpacity:"0"})]}),(0,A.jsxs)("radialGradient",{id:`networkRadialC-${n}`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(96.3816 -36.4455) rotate(114.614) scale(57.7177)",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-graphic-globe-lines, white)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-globe-lines, white)",stopOpacity:"0"})]}),(0,A.jsxs)("radialGradient",{id:`networkRadialD-${n}`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(137.86 7.73234) rotate(92.3288) scale(62.743)",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-graphic-globe-lines, white)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-globe-lines, white)",stopOpacity:"0"})]}),(0,A.jsxs)("radialGradient",{id:`networkRadialE-${n}`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(35.3203 -21.566) rotate(104.513) scale(54.8617)",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-graphic-globe-lines, white)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-globe-lines, white)",stopOpacity:"0"})]})]})]})})},"SlideThreeInner"),(0,A.jsxs)(O.P.div,{exit:{opacity:0},children:[(0,A.jsx)(O.P.div,{initial:e?void 0:{scale:1.1},animate:e?tO:void 0,transition:{...tF},style:{position:"absolute",inset:0,borderRadius:"50%",boxShadow:"0 0 0 2px var(--ck-graphic-globe-lines, rgba(126, 112, 243, 1))"}},"pulseA"),(0,A.jsx)(O.P.div,{initial:e?void 0:{scale:1.2,opacity:.25},animate:e?tO:void 0,transition:{...tF,delay:.5},style:{position:"absolute",inset:0,borderRadius:"50%",boxShadow:"0 0 0 2px var(--ck-graphic-globe-lines, rgba(126, 112, 243, 1))"}},"pulseB")]})]},e),(0,A.jsxs)(O.P.div,{initial:{rotate:-20,scale:.1,y:-10,x:-10},animate:{rotate:0,scale:1,y:0,x:0},exit:{zIndex:3,scale:.2,y:-25,x:15},style:{zIndex:12,borderRadius:"50%",position:"absolute",bottom:-4,right:-4,width:54,height:54,display:"flex",alignItems:"center",justifyContent:"center",padding:13,background:"var(--ck-graphic-compass-background, var(--ck-body-background))",boxShadow:"var(--ck-graphic-compass-box-shadow, 0px 2px 9px rgba(0, 0, 0, 0.15))"},children:[(0,A.jsx)(tD,{}),(0,A.jsx)(O.P.div,{style:{zIndex:2,position:"absolute"},initial:{rotate:-170},animate:{rotate:0},exit:{rotate:-180,transition:{duration:0}},transition:{type:"spring",stiffness:6,damping:.9,mass:.2},children:tH})]})]},"SlideThree")})},tJ=()=>{var e,n;let t;let o=nD({}),i=rm(),r=null!==(n=null===(e=i.options)||void 0===e?void 0:e.ethereumOnboardingUrl)&&void 0!==n?n:o.aboutScreen_ctaUrl,[a,c]=(0,M.useState)(!0),[s,d]=(0,M.useState)(0),l=(0,M.useRef)(!1),p=(0,M.useRef)(0),h=[.16,1,.3,1];(0,M.useEffect)(()=>()=>clearInterval(t),[]);let u=()=>{if(f.current){let{overflow:e}=getComputedStyle(f.current);return"visible"!==e}return!1},g=e=>{c(!1),u()?x(e):d(e)},x=e=>{if(f.current){let{offsetWidth:n}=f.current;f.current.scrollLeft=n*e,setTimeout(()=>d(e),100)}},b=()=>{if(!f.current)return;let{offsetWidth:e,scrollLeft:n}=f.current,t=p.current;p.current=n,t-n>-4&&t-n<4&&d(Math.round(n/e))},m=()=>{v()},C=()=>{let{offsetWidth:e,scrollLeft:n}=f.current;d(Math.round(n/e))},v=()=>{l.current=!0,clearTimeout(t)},f=(0,M.useRef)(null);(0,M.useEffect)(()=>{if(f.current)return f.current.addEventListener("scroll",b),f.current.addEventListener("touchmove",m),f.current.addEventListener("touchend",C),()=>{f.current&&(f.current.removeEventListener("scroll",b),f.current.removeEventListener("touchmove",m),f.current.removeEventListener("touchend",C))}},[f]);let k=[(0,A.jsx)(tY,{layoutId:"graphicCircle",duration:600,ease:h}),(0,A.jsx)(tQ,{layoutId:"graphicCircle",duration:600,ease:h}),(0,A.jsx)(tX,{layoutId:"graphicCircle",duration:600,ease:h})],w=[(0,A.jsx)(tY,{duration:600,ease:h}),(0,A.jsx)(tQ,{duration:600,ease:h}),(0,A.jsx)(tX,{duration:600,ease:h})],y=(()=>{var e;switch(null===(e=i.options)||void 0===e?void 0:e.language){case"en-US":case"zh-CN":return 64;default:return 84}})(),j=[(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(eJ,{style:{height:24},$small:!0,children:(0,A.jsx)(nP,{children:o.aboutScreen_a_h1})}),(0,A.jsx)(eq,{style:{height:y},children:(0,A.jsx)(nP,{children:o.aboutScreen_a_p})})]}),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(eJ,{style:{height:24},$small:!0,children:(0,A.jsx)(nP,{children:o.aboutScreen_b_h1})}),(0,A.jsx)(eq,{style:{height:y},children:(0,A.jsx)(nP,{children:o.aboutScreen_b_p})})]}),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(eJ,{style:{height:24},$small:!0,children:(0,A.jsx)(nP,{children:o.aboutScreen_c_h1})}),(0,A.jsx)(eq,{style:{height:y},children:(0,A.jsx)(nP,{children:o.aboutScreen_c_p})})]})];return(0,A.jsxs)(eP,{children:[(0,A.jsxs)(tM,{children:[(0,A.jsx)(tS,{children:(0,A.jsx)(W.x,{transition:{duration:.6,ease:h},children:(0,A.jsx)(F.N,{initial:!1,onExitComplete:()=>c(!0),children:k.map((e,n)=>s===n&&(0,A.jsx)(tN,{style:{position:"absolute"},children:e},n))})})}),(0,A.jsx)(tL,{ref:f,children:(0,A.jsx)(F.N,{children:j.map((e,n)=>(0,A.jsxs)(tA,{$active:s===n,children:[(0,A.jsx)(tE,{children:(0,A.jsx)(W.x,{transition:{duration:0},children:(0,A.jsx)(tN,{children:w[n]})})}),(0,A.jsx)(eX,{style:{gap:8,paddingBottom:0},children:e})]},n))})})]}),(0,A.jsx)(n3,{children:(0,A.jsx)(tI,{children:j.map((e,n)=>(0,A.jsx)(t_,{$active:s===n,onClick:()=>{v(),g(n)}},n))})}),(0,A.jsx)(ty,{href:r,arrow:!0,children:o.aboutScreen_ctaText})]})},tq=(0,T.i7)`
...
`,t4=ey(O.P.span)``,t9=ey(O.P.div)``,t8={desktop:{ConnectorButton:(0,T.AH)`
  ...
  &:after {
    ...
    animation: ${t3} 2s linear infinite;
  }
`,t7=ey.div`
  transition: opacity 300ms ease;
  min-width: fit-content;
  ...
  ${e=>e.$mobile?(0,T.AH)`
          ...
          ${t5} {
            flex-shrink: 0;
            width: 80px;
            ${t8.mobile.ConnectorButton}
            ${t4} {
              ${t8.mobile.ConnectorLabel}
              ${t6} {
                display: none;
                width: fit-content;
                margin: 0 auto;
        ...
        `:(0,T.AH)`
          ...
          ${t5} {
            ${t8.desktop.ConnectorButton}
            ${t4} {
              ${t8.desktop.ConnectorLabel}
            }
            ${t9} {
              ${t8.desktop.ConnectorIcon}
            }
          }
        `}
`;function oe(){var e;let n=(0,l.U)();return(null!==(e=null==n?void 0:n.chains)&&void 0!==e?e:[]).map(e=>e)}function on({...e}={}){let n=rm(),{connect:t,connectAsync:o,connectors:i,...r}=(0,p.e)({...e,mutation:{...e.mutation,onError(e){e.message?"User rejected request"!==e.message&&n.log(e.message,e):n.log("Could not connect.",e)}}});return{connect:({connector:e,chainId:o,mutation:i})=>{var r;return t({connector:e,chainId:null!=o?o:null===(r=n.options)||void 0===r?void 0:r.initialChainId},i)},connectAsync:async({connector:e,chainId:t,mutation:i})=>{var r;return o({connector:e,chainId:null!=t?t:null===(r=n.options)||void 0===r?void 0:r.initialChainId},i)},connectors:i,...r}}function ot(e){let{chains:n}=(0,l.U)();return!!e&&n.some(n=>n.id===e)}let oo=M.createContext({connect:{getUri:()=>""},dapp:{chains:[]},account:void 0}),oi=({enabled:e,children:n})=>{let{uri:t}=function({enabled:e}={enabled:!0}){let{log:n}=rm(),[t,o]=(0,M.useState)(void 0),i=nY("walletConnect"),{isConnected:r}=(0,s.F)(),{connectAsync:a}=on();return(0,M.useEffect)(()=>{if(e){if(r)o(void 0);else{if(!i||t)return;if(i&&!r)return l(i),n("add wc listeners"),i.emitter.on("message",c),i.emitter.on("disconnect",s),()=>{n("remove wc listeners"),i.emitter.off("message",c),i.emitter.off("disconnect",s)}}}async function c(e){let{type:t,data:i}=e;n("WC Message",t,i),"display_uri"===t&&o(i)}async function s(){n("WC Disconnect"),i&&d(i)}async function d(e){let n=await a({connector:e});return!!n&&n}async function l(e){try{await d(e)}catch(t){n("catch error"),n(t),t.code?4001===t.code?(n("error.code - User rejected"),l(e)):n("error.code - Unknown Error"):n("WalletConnect cannot connect.",t)}}},[e,i,r]),{uri:t}}({enabled:e}),{address:o,chain:i}=(0,s.F)(),r=ot(null==i?void 0:i.id),a=oe();return(0,A.jsx)(oo.Provider,{value:{connect:{getUri:e=>t},dapp:{chains:a},account:o?{chain:i,chainIsSupported:r,address:o}:void 0},children:n})},or=()=>M.useContext(oo);function oa(){let[e,n]=(0,M.useState)(eg());return(0,M.useEffect)(()=>{let e=()=>{n(eg())};return window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[]),e}let oc=ey.div`
  position: relative;
`,os=(0,T.i7)`
0%{ opacity:0; }
100%{ opacity:1; }
`,od=ey.div`
  ...
  span {
    ...
    animation: ${os} 300ms ease 1000ms both;
...
`,op=()=>(0,A.jsx)("svg",{width:"11",height:"12",viewBox:"0 0 11 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,A.jsx)("path",{d:"M5.49438 1L5.49438 11M5.49438 11L9.5 7M5.49438 11L1.5 7",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round",strokeLinejoin:"round"})}),oh=({children:e,height:n,backgroundColor:t,mobileDirection:o})=>{let i=(0,M.useRef)(null),r=(0,M.useRef)(null),a=oa();return(0,M.useEffect)(()=>{let e=i.current;if(!e)return;e.scrollHeight>e.clientHeight&&r.current&&r.current.classList.remove("hide");let n=n=>{let{scrollTop:t,scrollHeight:o,clientHeight:i,scrollLeft:a,scrollWidth:c,clientWidth:s}=n.target;r.current&&t>0&&r.current.classList.add("hide"),0===t&&0===a?e.classList.add("scroll-start"):e.classList.remove("scroll-start"),o-t===i&&c-a===s?e.classList.add("scroll-end"):e.classList.remove("scroll-end")};return e.addEventListener("scroll",n),n({target:e}),()=>{e.removeEventListener("scroll",n)}},[i.current]),(0,A.jsxs)(oc,{children:[(0,A.jsx)(ol,{ref:i,$mobile:a,$height:n,$backgroundColor:t,$mobileDirection:o,children:e}),(0,A.jsx)(od,{ref:r,className:"hide",onClick:()=>{i.current&&i.current.scrollTo({top:i.current.scrollHeight,behavior:"smooth"})},children:(0,A.jsxs)("span",{children:[(0,A.jsx)(op,{})," More Available"]})})]})},ou=ey(O.P.div)`
  display: flex;
  gap: 8px;
  position: relative;
  border-radius: 9px;
...
`,ox=({children:e,error:n,icon:t})=>(0,A.jsxs)(ou,{$error:n,children:[t&&(0,A.jsx)(og,{children:t}),(0,A.jsx)("div",{children:e})]});ox.displayName="Alert";let ob=()=>{let{storage:e}=(0,l.U)(),[n,t]=(0,M.useState)(null);return(0,M.useEffect)(()=>{(async()=>{let n=await (null==e?void 0:e.getItem("recentConnectorId"));t(null!=n?n:"")})()},[]),{lastConnectorId:n,updateLastConnectorId:n=>{null==e||e.setItem("recentConnectorId",n)}}},om=()=>{var e;let n=rm(),t=oa(),o=nX(),{lastConnectorId:i}=ob(),r=(null===(e=n.options)||void 0===e?void 0:e.hideRecentBadge)||"walletConnect"===i?o:[...o.filter(e=>i===e.connector.id),...o.filter(e=>i!==e.connector.id)];return(0,A.jsxs)(oh,{mobileDirection:"horizontal",children:[0===r.length&&(0,A.jsx)(ox,{error:!0,children:"No connectors found in ConnectKit config."}),r.length>0&&(0,A.jsx)(t7,{$mobile:t,$totalResults:r.length,children:r.map(e=>(0,A.jsx)(oC,{wallet:e,isRecent:e.id===i},e.id))})]})},oC=({wallet:e,isRecent:n})=>{var t,o,i,r;let{connect:{getUri:a}}=or(),c=a(),s=oa(),d=rm(),{connect:l}=on(),p=!e.isInstalled&&s||e.shouldDeeplinkDesktop&&!s?null===(t=e.getWalletConnectDeeplink)||void 0===t?void 0:t.call(e,null!=c?c:""):void 0,h=s&&eb(e.id),u=("safari"===el()||"ios"===el())&&em(e.connector.id);return(h||u)&&(p=void 0),(0,A.jsxs)(t5,{type:"button",as:p?"a":void 0,href:p||void 0,disabled:d.route!==rg.CONNECTORS,onClick:p?void 0:()=>{h?d.setRoute(rg.MOBILECONNECTORS):(u&&l({connector:null==e?void 0:e.connector}),d.setRoute(rg.CONNECT),d.setConnector({id:e.id}))},children:[(0,A.jsx)(t9,{"data-small":e.iconShouldShrink,"data-shape":e.iconShape,children:null!==(o=e.iconConnector)&&void 0!==o?o:e.icon}),(0,A.jsxs)(t4,{children:[s&&null!==(i=e.shortName)&&void 0!==i?i:e.name,!(null===(r=d.options)||void 0===r?void 0:r.hideRecentBadge)&&n&&(0,A.jsx)(t6,{children:(0,A.jsx)("span",{children:"Recent"})})]})]})},ov=()=>{var e,n,t,o,i;let r=rm(),a=nD({}),c=oa();return(0,A.jsxs)(eP,{style:{width:312},children:[(0,A.jsx)(om,{}),c?(0,A.jsx)(A.Fragment,{children:(0,A.jsxs)(tK,{children:[(0,A.jsxs)(eX,{style:{padding:0,textAlign:"left"},children:[(0,A.jsx)(eJ,{$small:!0,children:a.connectorsScreen_h1}),(0,A.jsx)(eq,{children:a.connectorsScreen_p})]}),(0,A.jsxs)(t$,{children:[!(null===(e=r.options)||void 0===e?void 0:e.hideQuestionMarkCTA)&&(0,A.jsx)(ty,{variant:"tertiary",onClick:()=>r.setRoute(rg.ABOUT),children:a.learnMore}),!(null===(n=r.options)||void 0===n?void 0:n.hideNoWalletCTA)&&(0,A.jsx)(ty,{variant:"tertiary",onClick:()=>r.setRoute(rg.ONBOARDING),children:a.getWallet})]})]})}):(0,A.jsx)(A.Fragment,{children:!(null===(t=r.options)||void 0===t?void 0:t.hideNoWalletCTA)&&(0,A.jsx)(t1,{children:(0,A.jsxs)(t0,{onClick:()=>r.setRoute(rg.ONBOARDING),children:[(0,A.jsx)(t2,{})," ",a.connectorsScreen_newcomer]})})}),(null===(o=r.options)||void 0===o?void 0:o.disclaimer)&&(0,A.jsx)(ni,{style:{visibility:"hidden",pointerEvents:"none"},children:(0,A.jsx)("div",{children:null===(i=r.options)||void 0===i?void 0:i.disclaimer})})]})},of=ey.div`
  text-align: center;
...
`,oj=ey.div`
  ...
  ${e=>e.$disabled&&(0,T.AH)`
      ...
      opacity: 0.4;
      ${of} {
        animation: ${oy} 1s infinite ease-in-out;
      }
    `}
`,oS=ey.div``;function oN(){let{log:e}=rm(),{connectAsync:n,connectors:t}=on(),[o,i]=(0,M.useState)(!1);return{isOpen:o,open:async()=>{let o=document.createElement("style");o.innerHTML="w3m-modal, wcm-modal{ --wcm-z-index: 2147483647; --w3m-z-index:2147483647; }",document.head.appendChild(o);let r=t.find(e=>eb(e.id));if(r)try{let t=(await r.getProvider()).rpc.projectId,a=(0,L.u)({projectId:t,showQrModal:!0});i(!0);try{await n({connector:a})}catch(n){e("WalletConnect",n)}i(!1),document.head.removeChild(o)}catch(n){e("Could not get WalletConnect provider",n)}else e("No WalletConnect connector available")}}}let oE=ey(O.P.div)`
  ...
  ${e=>e.$clipboard?(0,T.AH)`
        ...
        `}
`,oL=({copied:e,small:n})=>(0,A.jsx)(oE,{$clipboard:e,children:(0,A.jsx)(nf,{style:{transform:n?"scale(1)":"translateX(3px) scale(1.5)",opacity:n||e?1:.3}})}),oA=ey.div`
...
`,oI=({string:e,children:n,variant:t})=>{let o;let[i,r]=(0,M.useState)(!1),a=()=>{if(!e)return;let n=e.trim();navigator.clipboard&&navigator.clipboard.writeText(n),r(!0),clearTimeout(o),o=setTimeout(()=>r(!1),1e3)};return"button"===t?(0,A.jsx)(ty,{disabled:!e,onClick:a,icon:(0,A.jsx)(oL,{copied:i}),children:n}):(0,A.jsx)(oA,{onClick:a,$disabled:!e,children:(0,A.jsxs)(oM,{children:[n,(0,A.jsx)(oL,{copied:i,small:!0})]})})},o_=(0,A.jsx)("svg",{width:"60",height:"60",viewBox:"0 0 60 60",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,A.jsx)("path",{d:"M30 42V19M19 30.5H42",stroke:"var(--ck-body-color-muted)",strokeWidth:"3",strokeLinecap:"round"})}),oO=()=>{var e,n;let t=rm(),o=nD(),{connect:{getUri:i}}=or(),r=i(),{open:a,isOpen:c}=oN(),s=nX(),d=null!==(e=Object.keys(ef).filter(e=>{let n=ef[e];return!s.find(n=>n.connector.id===e)&&!!n.getWalletConnectDeeplink}))&&void 0!==e?e:[],l=e=>{var n;let t=null===(n=e.getWalletConnectDeeplink)||void 0===n?void 0:n.call(e,r);t&&(window.location.href=t)};return(0,A.jsx)(eP,{style:{width:312},children:(0,A.jsxs)(oS,{children:[(0,A.jsx)(eX,{style:{paddingBottom:0},children:(0,A.jsx)(oh,{height:340,children:(0,A.jsxs)(oj,{$disabled:!r,children:[d.sort((e,n)=>{var t,o,i,r;let a=ef[e],c=ef[n],s=null!==(o=null!==(t=a.name)&&void 0!==t?t:a.shortName)&&void 0!==o?o:e,d=null!==(r=null!==(i=c.name)&&void 0!==i?i:c.shortName)&&void 0!==r?r:n;return s.localeCompare(d)}).filter(e=>!("coinbaseWallet"===e||"com.coinbase.wallet"===e)).map((e,n)=>{let t=ef[e],{name:o,shortName:i,iconConnector:r,icon:a}=t;return(0,A.jsxs)(of,{onClick:()=>l(t),style:{animationDelay:`${50*n}ms`},children:[(0,A.jsx)(ok,{$outline:!0,children:null!=r?r:a}),(0,A.jsx)(ow,{children:null!=i?i:o})]},n)}),(0,A.jsxs)(of,{onClick:a,$waiting:c,children:[(0,A.jsx)(ok,{style:{background:"var(--ck-body-background-secondary)"},children:c?(0,A.jsx)("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center"},children:(0,A.jsx)("div",{style:{width:"50%"},children:(0,A.jsx)(tk,{})})}):o_}),(0,A.jsx)(ow,{children:o.more})]})]})})}),(null===(n=t.options)||void 0===n?void 0:n.walletConnectCTA)!=="modal"&&(0,A.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14,paddingTop:8},children:(0,A.jsx)(oI,{variant:"button",string:r,children:o.copyToClipboard})})]})})},oF=ey(O.P.div)`
  display: flex;
  flex-direction: column;
  gap: 6px;
  position: relative;
...
`,oR=ey(O.P.div)`
  ...
  ${e=>e.$shake&&(0,T.AH)`
      animation: ${oW} 220ms ease-out both;
      &:before {
        animation: ${oT} 220ms ease-out 750ms both;
      }
    `}
`,oB=ey(O.P.button)`
  z-index: 5;
...
`,oP=({children:e,message:n,open:t,xOffset:o=0,yOffset:i=0,delay:r})=>{var a;let c=rm(),s=nu();if(null===(a=c.options)||void 0===a?void 0:a.hideTooltips)return(0,A.jsx)(A.Fragment,{children:e});let[d,l]=(0,M.useState)(!1),[p,h]=(0,M.useState)(!1),[u,g]=(0,M.useState)("small"),[x,b]=(0,M.useState)(!1),[m]=(0,M.useState)(c.route),C=(0,M.useRef)(null),[v,f]=(0,B.A)({debounce:x?0:220,offsetSize:!0,scroll:!0}),k=()=>{let e=!1,n=o+f.left+f.width,t=i+f.top+.5*f.height;return(n>window.innerWidth||n<0||t>window.innerHeight||t<0)&&(e=!0),e};return("undefined"!=typeof window?M.useLayoutEffect:M.useEffect)(()=>{if(!C.current||f.top+f.bottom+f.left+f.right+f.height+f.width===0)return;let e=o+f.left+f.width,n=i+f.top+.5*f.height;x||0===e||0===n||b(!0),C.current.style.left=`${e}px`,C.current.style.top=`${n}px`,g(C.current.offsetHeight<=40?"small":"large"),h(k())},[f,t,d]),(0,M.useEffect)(()=>{c.open||l(!1)},[c.open]),(0,M.useEffect)(()=>{l(!!t)},[t]),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(O.P.div,{ref:v,style:void 0===t?{cursor:"help"}:{},onHoverStart:()=>l(!0),onHoverEnd:()=>l(!1),onClick:()=>l(!1),children:e}),(0,A.jsx)(eT,{children:(0,A.jsx)(F.N,{children:m===c.route&&!p&&d&&(0,A.jsx)(eW,{$useTheme:s.theme,$useMode:s.mode,$customTheme:s.customTheme,children:(0,A.jsx)(oU,{children:(0,A.jsxs)(oZ,{role:"tooltip",$size:u,ref:C,initial:"collapsed",animate:x?"open":{},exit:"collapsed",variants:{collapsed:{transformOrigin:"20px 50%",opacity:0,scale:.9,z:.01,y:"-50%",x:20,transition:{duration:.1}},open:{willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:"-50%",x:20,transition:{ease:[.76,0,.24,1],duration:.15,delay:r||.5}}},children:[n,(0,A.jsx)(oG,{$size:u})]})})})})})]})},oV=ey(O.P.div)`
  z-index: 4;
  position: relative;
  overflow: hidden;
  svg {
...
`,o8=({logo:e,smallLogo:n,connecting:t=!0,unavailable:o=!1,countdown:i=!1})=>(0,A.jsxs)(o2,{transition:{duration:.5,ease:[.175,.885,.32,.98]},children:[(0,A.jsx)(o3,{$small:!o&&n,style:o?{borderRadius:0}:void 0,children:e}),(0,A.jsx)(o5,{children:(0,A.jsxs)(F.N,{children:[t&&(0,A.jsx)(o9,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,transition:{duration:i?1:0}},children:(0,A.jsxs)("svg",{"aria-hidden":"true",width:"102",height:"102",viewBox:"0 0 102 102",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{d:"M52 100C24.3858 100 2 77.6142 2 50",stroke:"url(#paint0_linear_1943_4139)",strokeWidth:"3.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,A.jsx)("defs",{children:(0,A.jsxs)("linearGradient",{id:"paint0_linear_1943_4139",x1:"2",y1:"48.5",x2:"53",y2:"100",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]})},"Spinner"),i&&(0,A.jsxs)(o4,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.25},children:[(0,A.jsx)("div",{}),(0,A.jsx)("div",{})]},"ExpiringSpinner")]})})]}),o6={CONNECTED:"connected",CONNECTING:"connecting",EXPIRING:"expiring",FAILED:"failed",REJECTED:"rejected",NOTCONNECTED:"notconnected",UNAVAILABLE:"unavailable"},o7={initial:{willChange:"transform,opacity",position:"relative",opacity:0,scale:.95},animate:{position:"relative",opacity:1,scale:1,transition:{ease:[.16,1,.3,1],duration:.4,delay:.05,position:{delay:0}}},exit:{position:"absolute",opacity:0,scale:.95,transition:{ease:[.16,1,.3,1],duration:.3}}},ie=({switchConnectMethod:e,forceState:n})=>{var t,o,i,r,a,c,s,d;let l;let{connect:p}=on({mutation:{onMutate:e=>{e.connector?w(o6.CONNECTING):w(o6.UNAVAILABLE)},onError(e){console.error(e)},onSettled(e,n){if(n){if(m(!0),setTimeout(()=>m(!1),3500),n.code)switch(n.code){case -32002:w(o6.NOTCONNECTED);break;case 4001:w(o6.REJECTED);break;default:w(o6.FAILED)}else n.message&&("User rejected request"===n.message?w(o6.REJECTED):w(o6.FAILED))}setTimeout(h,100)}}}),{triggerResize:h,connector:u}=rm(),g=nQ(u.id),x={name:null==g?void 0:g.name,shortName:null!==(t=null==g?void 0:g.shortName)&&void 0!==t?t:null==g?void 0:g.name,icon:null!==(o=null==g?void 0:g.iconConnector)&&void 0!==o?o:null==g?void 0:g.icon,iconShape:null!==(i=null==g?void 0:g.iconShape)&&void 0!==i?i:"circle",iconShouldShrink:null==g?void 0:g.iconShouldShrink},[b,m]=(0,M.useState)(!1);(0,M.useState)(9);let C=el(),v=null===(r=null==g?void 0:g.downloadUrls)||void 0===r?void 0:r[C],f=(null==g?void 0:g.downloadUrls)?{name:Object.keys(null==g?void 0:g.downloadUrls)[0],label:(null===(a=Object.keys(null==g?void 0:g.downloadUrls)[0])||void 0===a?void 0:a.charAt(0).toUpperCase())+(null===(c=Object.keys(null==g?void 0:g.downloadUrls)[0])||void 0===c?void 0:c.slice(1)),url:null==g?void 0:g.downloadUrls[Object.keys(null==g?void 0:g.downloadUrls)[0]]}:void 0,[k,w]=(0,M.useState)(n||((null==g?void 0:g.isInstalled)?o6.CONNECTING:o6.UNAVAILABLE)),y=nD({CONNECTORNAME:x.name,CONNECTORSHORTNAME:null!==(s=x.shortName)&&void 0!==s?s:x.name,SUGGESTEDEXTENSIONBROWSER:null!==(d=null==f?void 0:f.label)&&void 0!==d?d:"your browser"}),j=async()=>{(null==g?void 0:g.isInstalled)&&(null==g?void 0:g.connector)?p({connector:null==g?void 0:g.connector}):w(o6.UNAVAILABLE)};return((0,M.useEffect)(()=>{if(k!==o6.UNAVAILABLE)return l=setTimeout(j,600),()=>{clearTimeout(l)}},[]),g)?eb(null==g?void 0:g.connector.id)?(0,A.jsx)(eP,{children:(0,A.jsxs)(oz,{children:[(0,A.jsx)(eY,{children:"Invalid State"}),(0,A.jsx)(eX,{children:(0,A.jsx)(ox,{children:"WalletConnect does not have an injection flow. This state should never happen."})})]})}):(0,A.jsx)(eP,{children:(0,A.jsxs)(oz,{children:[(0,A.jsx)(oD,{children:(0,A.jsxs)(oR,{$shake:k===o6.FAILED||k===o6.REJECTED,$circle:"circle"===x.iconShape,children:[(0,A.jsx)(F.N,{children:(k===o6.FAILED||k===o6.REJECTED)&&(0,A.jsx)(oB,{"aria-label":"Retry",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},whileTap:{scale:.9},transition:{duration:.1},onClick:j,children:(0,A.jsx)(oH,{children:(0,A.jsx)(oP,{open:b&&(k===o6.FAILED||k===o6.REJECTED),message:y.tryAgainQuestion,xOffset:-6,children:(0,A.jsx)(nC,{})})})})}),"circle"===x.iconShape?(0,A.jsx)(o8,{logo:k===o6.UNAVAILABLE?(0,A.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:x.icon}):(0,A.jsx)(A.Fragment,{children:x.icon}),smallLogo:x.iconShouldShrink,connecting:k===o6.CONNECTING,unavailable:k===o6.UNAVAILABLE}):(0,A.jsx)(oJ,{logo:k===o6.UNAVAILABLE?(0,A.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:x.icon}):(0,A.jsx)(A.Fragment,{children:x.icon}),connecting:k===o6.CONNECTING})]})}),(0,A.jsx)(eQ,{children:(0,A.jsxs)(F.N,{initial:!1,children:[k===o6.FAILED&&(0,A.jsx)(oF,{initial:"initial",animate:"animate",exit:"exit",variants:o7,children:(0,A.jsxs)(eX,{children:[(0,A.jsxs)(eJ,{$error:!0,children:[(0,A.jsx)(nx,{}),y.injectionScreen_failed_h1]}),(0,A.jsx)(eq,{children:y.injectionScreen_failed_p})]})},o6.FAILED),k===o6.REJECTED&&(0,A.jsx)(oF,{initial:"initial",animate:"animate",exit:"exit",variants:o7,children:(0,A.jsxs)(eX,{style:{paddingBottom:28},children:[(0,A.jsx)(eJ,{children:y.injectionScreen_rejected_h1}),(0,A.jsx)(eq,{children:y.injectionScreen_rejected_p})]})},o6.REJECTED),(k===o6.CONNECTING||k===o6.EXPIRING)&&(0,A.jsx)(oF,{initial:"initial",animate:"animate",exit:"exit",variants:o7,children:(0,A.jsxs)(eX,{style:{paddingBottom:28},children:[(0,A.jsx)(eJ,{children:"injected"===g.connector.id?y.injectionScreen_connecting_injected_h1:y.injectionScreen_connecting_h1}),(0,A.jsx)(eq,{children:"injected"===g.connector.id?y.injectionScreen_connecting_injected_p:y.injectionScreen_connecting_p})]})},o6.CONNECTING),k===o6.CONNECTED&&(0,A.jsx)(oF,{initial:"initial",animate:"animate",exit:"exit",variants:o7,children:(0,A.jsxs)(eX,{children:[(0,A.jsxs)(eJ,{$valid:!0,children:[(0,A.jsx)(nm,{})," ",y.injectionScreen_connected_h1]}),(0,A.jsx)(eq,{children:y.injectionScreen_connected_p})]})},o6.CONNECTED),k===o6.NOTCONNECTED&&(0,A.jsx)(oF,{initial:"initial",animate:"animate",exit:"exit",variants:o7,children:(0,A.jsxs)(eX,{children:[(0,A.jsx)(eJ,{children:y.injectionScreen_notconnected_h1}),(0,A.jsx)(eq,{children:y.injectionScreen_notconnected_p})]})},o6.NOTCONNECTED),k===o6.UNAVAILABLE&&(0,A.jsx)(oF,{initial:"initial",animate:"animate",exit:"exit",variants:o7,children:v?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsxs)(eX,{style:{paddingBottom:18},children:[(0,A.jsx)(eJ,{children:y.injectionScreen_install_h1}),(0,A.jsx)(eq,{children:y.injectionScreen_install_p})]}),!g.isInstalled&&v&&(0,A.jsx)(ty,{href:v,icon:(0,A.jsx)(o0,{}),children:y.installTheExtension})]}):(0,A.jsxs)(A.Fragment,{children:[(0,A.jsxs)(eX,{style:{paddingBottom:12},children:[(0,A.jsx)(eJ,{children:y.injectionScreen_unavailable_h1}),(0,A.jsx)(eq,{children:y.injectionScreen_unavailable_p})]}),!g.isInstalled&&f&&(0,A.jsxs)(ty,{href:null==f?void 0:f.url,icon:(0,A.jsx)(o0,{browser:null==f?void 0:f.name}),children:["Install on ",null==f?void 0:f.label]})]})},o6.UNAVAILABLE)]})})]})}):(0,A.jsx)(eP,{children:(0,A.jsxs)(oz,{children:[(0,A.jsx)(eY,{children:"Invalid State"}),(0,A.jsx)(eX,{children:(0,A.jsx)(ox,{children:"No connectors match the id given. This state should never happen."})})]})})},it=ey(O.P.div)`
  z-index: 3;
  position: relative;
  overflow: hidden;
  height: 0;
...
`,ir=ey(O.P.div)`
  ...
  &:after {
    ...
    animation: ${ii} 1000ms linear infinite both;
  }
`,ia=ey(O.P.div)`
  z-index: 6;
  position: absolute;
...
`,ic=ey(O.P.div)`
  ...
  ${e=>e.$wcLogo?(0,T.AH)`
        ...
        `}
`,is=(e,n)=>{let t=Array.prototype.slice.call(U.create(e,{errorCorrectionLevel:n}).modules.data,0),o=Math.sqrt(t.length);return t.reduce((e,n,t)=>(t%o==0?e.push([n]):e[e.length-1].push(n))&&e,[])};function id({ecl:e="M",size:n=200,uri:t,clearArea:o=!1,image:i,imageBackground:r="transparent"}){let a=o?76:0,c=n-20,s=(0,M.useMemo)(()=>{let n=[],o=is(t,e),s=c/o.length;if([{x:0,y:0},{x:1,y:0},{x:0,y:1}].forEach(({x:e,y:t})=>{let i=(o.length-7)*s*e,r=(o.length-7)*s*t;for(let o=0;o<3;o++)n.push((0,A.jsx)("rect",{fill:o%2!=0?"var(--ck-qr-background, var(--ck-body-background))":"var(--ck-qr-dot-color)",rx:-((o-2)*5)+(0===o?2:3),ry:-((o-2)*5)+(0===o?2:3),width:s*(7-2*o),height:s*(7-2*o),x:i+s*o,y:r+s*o},`${o}-${e}-${t}`))}),i){let e=(o.length-7)*s*1,t=(o.length-7)*s*1;n.push((0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)("rect",{fill:r,rx:12,ry:12,width:7*s,height:7*s,x:e+0*s,y:t+0*s}),(0,A.jsx)("foreignObject",{width:7*s,height:7*s,x:e+0*s,y:t+0*s,children:(0,A.jsx)("div",{style:{borderRadius:12,overflow:"hidden"},children:i})})]}))}let d=Math.floor((a+25)/s),l=o.length/2-d/2,p=o.length/2+d/2-1;return o.forEach((e,t)=>{e.forEach((e,r)=>{o[t][r]&&!(t<7&&r<7||t>o.length-8&&r<7||t<7&&r>o.length-8)&&(i||!(t>l&&t<p&&r>l&&r<p))&&n.push((0,A.jsx)("circle",{cx:t*s+s/2,cy:r*s+s/2,fill:"var(--ck-qr-dot-color)",r:s/3},`circle-${t}-${r}`))})}),n},[e,c,t]);return(0,A.jsxs)("svg",{height:c,width:c,viewBox:`0 0 ${c} ${c}`,style:{width:c,height:c},children:[(0,A.jsx)("rect",{fill:"transparent",height:c,width:c}),s]})}function il({value:e,image:n,imageBackground:t,imagePosition:o="center",tooltipMessage:i}){let r=function(){let[e,n]=(0,M.useState)({width:0,height:0});return(0,M.useEffect)(()=>{function e(){n({width:window.innerWidth,height:window.innerHeight})}return window.addEventListener("resize",e),e(),()=>window.removeEventListener("resize",e)},[]),e}().width>920&&i?(0,A.jsx)(oP,{xOffset:139,yOffset:5,delay:.1,message:i,children:n}):n;return(0,A.jsx)(it,{children:(0,A.jsxs)(io,{children:[n&&(0,A.jsx)(ia,{children:(0,A.jsx)(ic,{$wcLogo:"center"!==o,style:{background:"center"===o?t:void 0},children:r})}),(0,A.jsx)(F.N,{initial:!1,children:e?(0,A.jsx)(O.P.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:(0,A.jsx)(id,{uri:e,size:288,ecl:"M",clearArea:!!("center"===o&&n)})},e):(0,A.jsxs)(ir,{initial:{opacity:.1},animate:{opacity:.1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:[(0,A.jsx)("span",{}),(0,A.jsx)("span",{}),(0,A.jsx)("span",{}),(0,A.jsx)("div",{})]})})]})})}il.displayName="CustomQRCode";let ip=ey(O.P.div)`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,ih=({logo:e})=>{let n=[(0,A.jsx)(er.MetaMask,{background:!0}),(0,A.jsx)(er.Coinbase,{background:!0}),(0,A.jsx)(er.Crypto,{}),(0,A.jsx)(er.ImToken,{}),(0,A.jsx)(er.Argent,{}),(0,A.jsx)(er.Trust,{})];return(0,A.jsx)(ip,{children:(0,A.jsxs)("svg",{"aria-hidden":"true",width:"47",height:"52",viewBox:"0 0 47 52",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsxs)("g",{mask:"url(#gradient-mask)",children:[(0,A.jsx)("path",{d:"M7 14.5C7 11.4624 9.46243 9 12.5 9H31.5C34.5376 9 37 11.4624 37 14.5V47H7V14.5Z",fill:"var(--ck-graphic-scaniconwithlogos-04)"}),e?(0,A.jsx)("foreignObject",{x:"13",y:"21",width:"18",height:"18",rx:"5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:5},children:e})}):(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)("foreignObject",{x:"12",y:"15",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[0]})}),(0,A.jsx)("foreignObject",{x:"23",y:"15",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[1]})}),(0,A.jsx)("foreignObject",{x:"12",y:"26",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[2]})})}),(0,A.jsx)("foreignObject",{x:"23",y:"26",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[3]})}),(0,A.jsx)("foreignObject",{x:"12",y:"37",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[4]})}),(0,A.jsx)("foreignObject",{x:"23",y:"37",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[5]})})]}),(0,A.jsx)("path",{d:"M36 47V13.7143C36 11.1107 33.8893 9 31.2857 9H12.7143C10.1107 9 8 11.1107 8 13.7143V47",stroke:"url(#paint0_linear_924_12568)",strokeWidth:"2"}),(0,A.jsx)("path",{d:"M15 10H29C29 11.1046 28.1046 12 27 12H17C15.8954 12 15 11.1046 15 10Z",fill:"var(--ck-graphic-scaniconwithlogos-01)"}),(0,A.jsx)("rect",{x:"1",y:"47",width:"43",height:"5",fill:"var(--ck-tooltip-background)"}),(0,A.jsx)("rect",{x:"22",y:"1",width:"24",height:"24",rx:"12",fill:"var(--ck-graphic-scaniconwithlogos-03)",stroke:"var(--ck-tooltip-background)",strokeWidth:"2"}),(0,A.jsx)("rect",{x:"34.5",y:"10",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,A.jsx)("rect",{x:"31",y:"10",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,A.jsx)("rect",{x:"31",y:"13.5",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,A.jsx)("rect",{x:"34.5",y:"13.5",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,A.jsx)("path",{d:"M28.5 10.5V9C28.5 8.17157 29.1716 7.5 30 7.5H31.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,A.jsx)("path",{d:"M36.5 7.5L38 7.5C38.8284 7.5 39.5 8.17157 39.5 9L39.5 10.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,A.jsx)("path",{d:"M39.5 15.5L39.5 17C39.5 17.8284 38.8284 18.5 38 18.5L36.5 18.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,A.jsx)("path",{d:"M31.5 18.5L30 18.5C29.1716 18.5 28.5 17.8284 28.5 17L28.5 15.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})]}),(0,A.jsxs)("defs",{children:[(0,A.jsxs)("linearGradient",{id:"paint0_linear_924_12568",x1:"22",y1:"8.2549",x2:"22",y2:"47",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-graphic-scaniconwithlogos-01)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-scaniconwithlogos-02)"})]}),(0,A.jsxs)("linearGradient",{id:"linear-gradient-mask",x1:"47",y1:"42",x2:"47",y2:"47",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"white"}),(0,A.jsx)("stop",{offset:"1",stopColor:"black",stopOpacity:"0"})]}),(0,A.jsx)("mask",{id:"gradient-mask",children:(0,A.jsx)("rect",{x:"0",y:"0",width:"47",height:"52",fill:"url(#linear-gradient-mask)"})})]})]})})},iu=({switchConnectMethod:e})=>{var n,t,o,i,r,a,c,s;let d=rm(),l=d.connector.id,p=nQ(d.connector.id),{open:h,isOpen:u}=oN(),{connect:{getUri:g}}=or(),x=g(l),b=x?null!==(t=null===(n=null==p?void 0:p.getWalletConnectDeeplink)||void 0===n?void 0:n.call(p,x))&&void 0!==t?t:x:void 0,m=nD({CONNECTORNAME:null==p?void 0:p.name});if(!p)return(0,A.jsxs)(A.Fragment,{children:["Wallet not found ",d.connector.id]});let C=null==p?void 0:p.downloadUrls,v={chrome:null==C?void 0:C.chrome,firefox:null==C?void 0:C.firefox,brave:null==C?void 0:C.brave,edge:null==C?void 0:C.edge,safari:null==C?void 0:C.safari};el();let f=C&&0!==Object.keys(C).length;v&&(Object.keys(v)[0],null===(o=Object.keys(v)[0])||void 0===o||o.charAt(0).toUpperCase(),null===(i=Object.keys(v)[0])||void 0===i||i.slice(1),v[Object.keys(v)[0]]);let k=eb(l);return(0,A.jsxs)(eP,{children:[(0,A.jsxs)(eX,{style:{paddingBottom:8,gap:14},children:[(0,A.jsx)(il,{value:b,image:null==p?void 0:p.icon,tooltipMessage:eb(l)?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(ih,{}),(0,A.jsx)("span",{children:m.scanScreen_tooltip_walletConnect})]}):(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(ih,{logo:null==p?void 0:p.icon}),(0,A.jsx)("span",{children:m.scanScreen_tooltip_default})]})}),k?(0,A.jsx)(n3,{}):f&&(0,A.jsx)(n3,{children:m.dontHaveTheApp})]}),k&&(0,A.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14},children:[(null===(r=d.options)||void 0===r?void 0:r.walletConnectCTA)!=="modal"&&(0,A.jsx)(oI,{variant:"button",string:b,children:(null===(a=d.options)||void 0===a?void 0:a.walletConnectCTA)==="link"?m.copyToClipboard:m.copyCode}),(null===(c=d.options)||void 0===c?void 0:c.walletConnectCTA)!=="link"&&(0,A.jsx)(ty,{icon:(0,A.jsx)(ng,{}),onClick:h,disabled:u,waiting:u,children:(null===(s=d.options)||void 0===s?void 0:s.walletConnectCTA)==="modal"?m.useWalletConnectModal:m.useModal})]}),f&&(0,A.jsx)(A.Fragment,{children:(0,A.jsx)(ty,{onClick:()=>{d.setRoute(rg.DOWNLOAD)},download:!0,children:m.getWalletName})})]})},ig={QRCODE:"qrcode",INJECTOR:"injector"},ix=()=>{let e=rm(),n=nQ(e.connector.id),t=!(null==n?void 0:n.isInstalled)&&(null==n?void 0:n.getWalletConnectDeeplink),[o,i]=(0,M.useState)(t?ig.QRCODE:ig.INJECTOR);return((0,M.useEffect)(()=>{let t=async()=>{await (null==n?void 0:n.connector.getProvider())||(i(ig.QRCODE),setTimeout(e.triggerResize,10))};o===ig.INJECTOR&&t()},[]),n)?(0,A.jsxs)(F.N,{children:[o===ig.QRCODE&&(0,A.jsx)(O.P.div,{initial:"initial",animate:"animate",exit:"exit",variants:n1,children:(0,A.jsx)(iu,{switchConnectMethod:e=>{i(ig.INJECTOR)}})},ig.QRCODE),o===ig.INJECTOR&&(0,A.jsx)(O.P.div,{initial:"initial",animate:"animate",exit:"exit",variants:n1,children:(0,A.jsx)(ie,{switchConnectMethod:e=>{i(ig.QRCODE)}})},ig.INJECTOR)]}):(0,A.jsxs)(ox,{children:["Connector not found ",e.connector.id]})},ib=()=>{var e,n,t;let o=nQ(rm().connector.id),i=nD({CONNECTORNAME:null==o?void 0:o.name});if(!o)return(0,A.jsx)(A.Fragment,{children:"Wallet not found"});let r={ios:null===(e=o.downloadUrls)||void 0===e?void 0:e.ios,android:null===(n=o.downloadUrls)||void 0===n?void 0:n.android,redirect:null===(t=o.downloadUrls)||void 0===t?void 0:t.download},a=r.ios&&r.android?i.downloadAppScreen_iosAndroid:r.ios?i.downloadAppScreen_ios:i.downloadAppScreen_android;return(0,A.jsx)(eP,{children:(0,A.jsxs)(eX,{style:{paddingBottom:4,gap:14},children:[r.redirect&&(0,A.jsx)(il,{value:r.redirect}),!r.redirect&&(0,A.jsx)(A.Fragment,{children:"No download link available"}),(0,A.jsx)(eq,{style:{fontSize:15,lineHeight:"20px",padding:"0 12px"},children:a})]})})},im=ey(O.P.div)`
  padding: 18px 0 20px;
  @media only screen and (max-width: ${ez.mobileWidth}px) {
    padding: 16px 0 20px;
  }
...
`,ij=ey(O.P.div)`
  ...
  &:before {
    ...
    opacity: 0.75;
    background-size: 200% 100%;
    animation: ${iy} 1000ms linear infinite both;
  }
`,iS=ey(O.P.div)`
...
`,iB=ey(O.P.button)`
  ...
  @media only screen and (min-width: ${ez.mobileWidth}px) {
    &:hover {
      &:before {
...
`,iZ=(0,A.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M2 16.75C2.69036 16.75 3.25 17.3096 3.25 18V19C3.25 26.5939 9.40609 32.75 17 32.75V35.25C8.02537 35.25 0.75 27.9746 0.75 19V18C0.75 17.3096 1.30964 16.75 2 16.75Z",fill:"url(#paint0_linear_1288_18701)"}),(0,A.jsx)("defs",{children:(0,A.jsxs)("linearGradient",{id:"paint0_linear_1288_18701",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]}),iG=({variant:e})=>{let{connector:n,chain:t}=(0,s.F)(),{chains:o,isPending:i,switchChain:r,error:a}=(0,d.R)(),[c,l]=(0,M.useState)(void 0),p=nD({}),h=eg(),u=(null==a?void 0:a.code)===4902,g=u||!r,x=e=>{r&&(l(e),r({chainId:e}))},{triggerResize:b}=rm();return(0,A.jsxs)(iF,{style:{marginBottom:void 0!==r?-8:0},children:[(0,A.jsx)(iD,{children:(0,A.jsx)(iR,{children:o.map(o=>{var r;let a={...iO.find(e=>e.id===o.id),...o};return(0,A.jsxs)(iB,{$variant:e,disabled:g||a.id===(null==t?void 0:t.id)||i&&c===a.id,onClick:()=>null==x?void 0:x(a.id),style:{opacity:g&&a.id!==(null==t?void 0:t.id)?.4:void 0},children:[(0,A.jsxs)("span",{style:{display:"flex",alignItems:"center",justifyContent:"flex-start",gap:12,color:a.id===(null==t?void 0:t.id)?"var(--ck-dropdown-active-color, inherit)":"inherit"},children:[(0,A.jsxs)(iT,{children:[(0,A.jsx)(iz,{initial:{opacity:0},animate:{opacity:i&&c===a.id?1:0},transition:{ease:[.76,0,.24,1],duration:.15,delay:.1},children:(0,A.jsx)(O.P.div,{animate:h&&em(null==n?void 0:n.id)&&i&&c===a.id?{opacity:[1,0],transition:{delay:4,duration:3}}:{opacity:1},children:iZ},`${null==a?void 0:a.id}-${null==a?void 0:a.name}`)}),(0,A.jsx)(iW,{children:null!==(r=a.logo)&&void 0!==r?r:(0,A.jsx)(i_.UnknownChain,{})})]}),a.name]}),"secondary"!==e&&(0,A.jsx)(iH,{children:(0,A.jsxs)(F.N,{initial:!1,exitBeforeEnter:!0,children:[a.id===(null==t?void 0:t.id)&&(0,A.jsx)(O.P.span,{style:{color:"var(--ck-dropdown-active-color, var(--ck-focus-color))",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4,transition:{duration:.1,delay:0}},transition:{ease:[.76,0,.24,1],duration:.3,delay:.2},children:p.connected},"connectedText"),i&&c===a.id&&(0,A.jsx)(O.P.span,{style:{color:"var(--ck-dropdown-pending-color, inherit)",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4},transition:{ease:[.76,0,.24,1],duration:.3,delay:.1},children:(0,A.jsx)(O.P.span,{animate:h&&em(null==n?void 0:n.id)&&{opacity:[1,0],transition:{delay:4,duration:4}},children:p.approveInWallet})},"approveText")]})}),"secondary"===e?(0,A.jsx)(iU,{initial:!1,animate:{opacity:a.id===(null==t?void 0:t.id)?1:0},transition:{duration:.3,ease:"easeOut"}}):a.id===(null==t?void 0:t.id)&&(0,A.jsx)(iU,{layoutId:"activeChain",layout:"position",transition:{duration:.3,ease:"easeOut"}})]},`${null==a?void 0:a.id}-${null==a?void 0:a.name}`)})})}),(0,A.jsx)(F.N,{children:u&&(0,A.jsx)(O.P.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{ease:[.76,0,.24,1],duration:.3},onAnimationStart:b,onAnimationComplete:b,children:(0,A.jsx)("div",{style:{paddingTop:10,paddingBottom:8},children:(0,A.jsxs)(ox,{children:[p.warnings_walletSwitchingUnsupported," ",p.warnings_walletSwitchingUnsupportedResolve]})})})})]})},iP=ey(O.P.div)`
  z-index: 2147483647;
  position: fixed;
  inset: 0;
`,iV=ey(O.P.div)`
...
`,iQ=ey(O.P.div)`
  ...
  user-select: none;
  color: var(--ck-dropdown-color, var(--ck-tooltip-color));
`,iX=({children:e,open:n,onClose:t,offsetX:o=0,offsetY:i=8})=>{var r,a,c;let s=rm(),d=nu(),l=nD(),[p,h]=(0,M.useState)({x:0,y:0});ns(n);let u=(0,M.useRef)(null);(0,M.useEffect)(()=>{let e=e=>{var o,i,r;if(n&&("Escape"===e.key&&t(),"ArrowDown"===e.key||"ArrowUp"===e.key)){if(!u.current)return;e.preventDefault();let n=null===(o=u.current)||void 0===o?void 0:o.querySelectorAll(`
            a[href]:not(:disabled),
            button:not(:disabled),
            textarea:not(:disabled),
            input[type="text"]:not(:disabled),
            ...
            input[type="checkbox"]:not(:disabled),
            select:not(:disabled)
          `),t=n[0],a=n[n.length-1];if("ArrowUp"===e.key){if(document.activeElement===t)a.focus();else{let e=null===(i=null==document?void 0:document.activeElement)||void 0===i?void 0:i.previousSibling;for(e||(e=a);e.disabled;)e=e.previousSibling;e.focus()}}else if(document.activeElement===a)t.focus();else{let e=null===(r=null==document?void 0:document.activeElement)||void 0===r?void 0:r.nextSibling;for(e||(e=t);e.disabled;)e=e.nextSibling;e.focus()}}};return document.addEventListener("keydown",e),()=>{document.removeEventListener("keydown",e)}},[n]);let g=(0,M.useRef)(null),x=(0,M.useCallback)(e=>{e&&(g.current=e,C())},[n]),[b,m]=(0,B.A)({debounce:120,offsetSize:!0,scroll:!0}),C=()=>{if(!g.current||m.top+m.bottom+m.left+m.right+m.height+m.width===0)return;let e=m.left+o,n=m.top+m.height+i;g.current.style.left=`${e}px`,g.current.style.top=`${n}px`};return("undefined"!=typeof window?M.useLayoutEffect:M.useEffect)(C,[g.current,m,n]),(0,M.useEffect)(C,[n,g.current]),(0,M.useEffect)(()=>(C(),window.addEventListener("scroll",t),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t),window.removeEventListener("resize",t)}),[]),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)("div",{ref:b,children:e}),(0,A.jsx)(F.N,{children:n&&(0,A.jsx)(eT,{children:(0,A.jsx)(eW,{$useTheme:null!==(r=d.theme)&&void 0!==r?r:s.theme,$useMode:null!==(a=d.mode)&&void 0!==a?a:s.mode,$customTheme:null!==(c=d.customTheme)&&void 0!==c?c:s.customTheme,children:(0,A.jsx)(nd,{children:(0,A.jsxs)(iP,{ref:u,children:[(0,A.jsx)(iV,{onClick:t}),(0,A.jsxs)(iY,{ref:x,style:{left:p.x,top:p.y},initial:"collapsed",animate:"open",exit:"collapsed",variants:{collapsed:{transformOrigin:"0 0",opacity:0,scale:.96,z:.01,y:-4,x:0,transition:{duration:.1}},open:{transformOrigin:"0 0",willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:0,x:0,transition:{ease:[.76,0,.24,1],duration:.15}}},children:[(0,A.jsx)(iQ,{children:l.switchNetworks}),(0,A.jsx)(iG,{})]})]})})})})})]})},iJ=ey.div`
  --bg: transparent;
  --color: #333;
...
`,i0=(0,A.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.3592 30.1654C10.0472 29.4491 8.85718 28.524 7.83713 27.424C6.81708 26.324 5.98425 25.0677 5.36889 23.7054C5.20157 23.335 5.05033 22.9567 4.91578 22.5717C4.51465 21.4237 4.26735 20.2308 4.17794 19.0239C4.16599 18.8626 4.13894 18.7041 4.09809 18.5507C3.85023 17.6197 3.09399 16.8738 2.11531 16.7999C0.975331 16.7138 -0.0310983 17.5702 0.0141657 18.7125C0.0223289 18.9185 0.0340286 19.1243 0.049253 19.3298C0.165374 20.8971 0.486545 22.4464 1.00749 23.9373C1.10424 24.2142 1.20764 24.4884 1.31755 24.7596C2.13617 26.7799 3.31595 28.6371 4.80146 30.239C6.28696 31.841 8.04998 33.1573 10.0029 34.1258C10.2651 34.2558 10.5307 34.3796 10.7995 34.4969C12.247 35.1287 13.7676 35.5656 15.3217 35.7995C15.5255 35.8301 15.7298 35.8573 15.9346 35.881C17.0703 36.0122 18.0001 35.0731 18.0001 33.9299C18.0001 32.9484 17.3133 32.1381 16.4036 31.8208C16.2537 31.7685 16.0977 31.7296 15.9377 31.7056C14.7411 31.5255 13.5702 31.1891 12.4556 30.7026C12.0818 30.5394 11.716 30.3601 11.3592 30.1654Z",fill:"url(#paint0_linear_1288_1870)"}),(0,A.jsx)("defs",{children:(0,A.jsxs)("linearGradient",{id:"paint0_linear_1288_1870",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0.7"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0"})]})})]}),i2=({id:e,unsupported:n,radius:t="50%",size:o=24})=>{var i;let r=ot(e),a=iO.find(n=>n.id===e);return iE()?(0,A.jsx)(iJ,{size:o,radius:t,children:(0,A.jsxs)(F.N,{initial:!1,children:[(null!=n?n:!r)&&(0,A.jsx)(i1,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,A.jsxs)("svg",{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{d:"M2.61317 11.2501H9.46246C10.6009 11.2501 11.3256 10.3506 11.3256 9.3549C11.3256 9.05145 11.255 8.73244 11.0881 8.43303L7.65903 2.14708C7.659 2.14702 7.65897 2.14696 7.65893 2.1469C7.65889 2.14682 7.65884 2.14673 7.65879 2.14664C7.31045 1.50746 6.6741 1.17871 6.04 1.17871C5.41478 1.17871 4.763 1.50043 4.41518 2.14968L0.993416 8.43476C0.828865 8.72426 0.75 9.04297 0.75 9.3549C0.75 10.3506 1.47471 11.2501 2.61317 11.2501Z",fill:"currentColor",stroke:"var(--ck-body-background, #fff)",strokeWidth:"1.5"}),(0,A.jsx)("path",{d:"M6.03258 7.43916C5.77502 7.43916 5.63096 7.29153 5.62223 7.02311L5.55675 4.96973C5.54802 4.69684 5.74446 4.5 6.02821 4.5C6.3076 4.5 6.51277 4.70131 6.50404 4.9742L6.43856 7.01864C6.42546 7.29153 6.2814 7.43916 6.03258 7.43916ZM6.03258 9.11676C5.7401 9.11676 5.5 8.9065 5.5 8.60677C5.5 8.30704 5.7401 8.09678 6.03258 8.09678C6.32506 8.09678 6.56515 8.30256 6.56515 8.60677C6.56515 8.91097 6.32069 9.11676 6.03258 9.11676Z",fill:"white"})]})}),e?(0,A.jsx)(iq,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:null!==(i=null==a?void 0:a.logo)&&void 0!==i?i:(0,A.jsx)(i_.UnknownChain,{})},`${null==a?void 0:a.id}-${null==a?void 0:a.name}-${e}`):(0,A.jsx)(i$,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:i0},"loading")]})}):(0,A.jsx)("div",{style:{width:o,height:o}})},i3=ey(O.P.div)``,i5=ey(O.P.button)`
  ...
  ${e=>e.disabled?(0,T.AH)`
        ...
        `}
`,i4=({...e})=>(0,A.jsx)("svg",{"aria-hidden":"true",width:"11",height:"6",viewBox:"0 0 11 6",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,A.jsx)("path",{d:"M1.5 1L5.5 5L9.5 1",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),i9=()=>{let e=rm(),[n,t]=(0,M.useState)(!1),{chain:o}=(0,s.F)(),{chains:i}=(0,d.R)(),r=nD({CHAIN:null==o?void 0:o.name}),a=eg()||(null==window?void 0:window.innerWidth)<ez.mobileWidth;(0,M.useEffect)(()=>{e.open||t(!1)},[e.open]);let c=i.length<=1;return(0,A.jsx)(A.Fragment,{children:(0,A.jsx)(i3,{children:(0,A.jsx)(iX,{offsetX:-12,open:!a&&n,onClose:()=>t(!1),children:(0,A.jsxs)(i5,{"aria-label":ex(r.switchNetworks).toString(),disabled:c,onClick:()=>{a?e.setRoute(rg.SWITCHNETWORKS):t(!n)},children:[c?(0,A.jsx)(oP,{message:r.chainNetwork,xOffset:-6,delay:.01,children:(0,A.jsx)(i2,{id:null==o?void 0:o.id})}):(0,A.jsx)(i2,{id:null==o?void 0:o.id}),!c&&(0,A.jsx)(i4,{style:{top:1,left:-3}})]})})})})},i8=({closeModal:e})=>{var n,t,o;let i=rm(),r=nu(),a=nD(),{reset:c}=(0,p.e)(),{disconnect:d}=(0,b.u)(),{address:l,isConnected:h,connector:u,chain:x}=(0,s.F)(),C=iA(),{data:v}=(0,g.v)({chainId:1,address:l,config:C}),{data:f}=(0,m.A)({address:l}),[k,w]=(0,M.useState)(!1);(0,M.useEffect)(()=>{h||i.setOpen(!1)},[h]),(0,M.useEffect)(()=>{if(k)return e?e():i.setOpen(!1),()=>{d(),c()}},[k,d,c]);let y=["web95","rounded","minimal"].includes(null!==(t=null!==(n=r.theme)&&void 0!==n?n:i.theme)&&void 0!==t?t:"")?"....":void 0;return(0,A.jsxs)(eP,{children:[(0,A.jsxs)(eX,{style:{paddingBottom:22,gap:6},children:[(0,A.jsx)(im,{children:(0,A.jsxs)(iC,{children:[(0,A.jsx)(iv,{children:(0,A.jsx)(i9,{})}),(0,A.jsx)(iM,{address:l})]})}),(0,A.jsx)(eJ,{children:(0,A.jsx)(oI,{string:l,children:null!=v?v:ec(l,y)})}),(null===(o=null==i?void 0:i.options)||void 0===o?void 0:o.hideBalance)?null:(0,A.jsx)(eq,{children:(0,A.jsx)(ik,{children:(0,A.jsxs)(F.N,{exitBeforeEnter:!0,initial:!1,children:[f&&(0,A.jsxs)(iw,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:[ed(Number(null==f?void 0:f.formatted))," ",null==f?void 0:f.symbol]},`chain-${null==x?void 0:x.id}`),!f&&(0,A.jsx)(ij,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:"\xa0"})]})})})]}),!eC(null==u?void 0:u.id)&&(0,A.jsx)(ty,{onClick:()=>w(!0),icon:(0,A.jsx)(nb,{}),children:a.disconnect})]})},i6=()=>{let{reset:e}=(0,p.e)(),{disconnect:n}=(0,b.u)(),{connector:t,chain:o}=(0,s.F)(),i=ot(null==o?void 0:o.id),r=nD({});return(0,A.jsx)(eP,{style:{width:278},children:(0,A.jsxs)(eX,{style:{padding:0,marginTop:-10},children:[!i&&(0,A.jsxs)(eq,{children:[r.warnings_chainUnsupported," ",r.warnings_chainUnsupportedResolve]}),(0,A.jsx)("div",{style:{padding:"6px 8px"},children:(0,A.jsx)(iG,{variant:"secondary"})}),!i&&!eC(null==t?void 0:t.id)&&(0,A.jsxs)("div",{style:{paddingTop:12},children:[(0,A.jsx)(n3,{}),(0,A.jsx)(ty,{icon:(0,A.jsx)(nb,{}),variant:"secondary",onClick:()=>{n(),e()},children:r.disconnect})]})]})})},i7=(0,T.i7)`
  from{ transform: rotate(0deg); }
  to{   transform: rotate(360deg); }
`,re=(0,T.i7)`
...
`,ro=ey(O.P.div)`
  ...
  &:before {
    ...
    background: var(--ck-body-background);
    transition: inherit;
    animation: ${i7} 10s linear infinite;
  }
  &:after {
    z-index: 2;
    content: '';
...
`,rr=ey(O.P.div)`
  ...
  ${({$connected:e})=>e&&(0,T.AH)`
    ...
    `};
`,ra=({showSignOutButton:e,onSignIn:n,onSignOut:t})=>{let o=iE(),i=nD(),{setOpen:r}=rf(),{isSignedIn:a,isReady:c,isLoading:d,isRejected:l,isSuccess:p,isError:h,signIn:u,signOut:g,error:x}=ny({onSignIn:e=>null==n?void 0:n(e),onSignOut:()=>null==t?void 0:t()}),{address:b}=(0,s.F)();return o?e&&a?(0,A.jsx)(ty,{style:{margin:0},onClick:g,icon:(0,A.jsx)(nb,{}),children:i.signOut},"button"):b?(0,A.jsx)(ty,{style:{margin:0},arrow:!a&&!d&&!l,onClick:d||p?void 0:u,disabled:d,waiting:d,icon:l&&(0,A.jsx)(O.P.div,{initial:{rotate:-270},animate:{rotate:0},transition:{duration:1,ease:[.175,.885,.32,.98]},children:(0,A.jsx)(nv,{style:{opacity:.4}})}),children:p?i.signedIn:l?i.tryAgain:d?i.awaitingConfirmation:h?null!=x?x:"Unknown Error":i.signIn},"button"):(0,A.jsx)(ty,{style:{margin:0},onClick:()=>r(!0),arrow:!0,children:i.walletNotConnected},"button"):(0,A.jsx)(ty,{style:{margin:0},disabled:!0},"loading")},rc=({src:e,alt:n,width:t,height:o})=>{let i=(0,M.useRef)(null),[r,a]=(0,M.useState)(!0);return(0,M.useEffect)(()=>{i.current&&i.current.complete&&0!==i.current.naturalHeight||a(!1)},[e]),(0,A.jsx)("div",{style:{width:t,height:o,background:"rgba(0,0,0,0.02)",boxShadow:"inset 0 0 0 1px rgba(0,0,0,0.02)"},children:(0,A.jsx)("img",{ref:i,src:e,alt:n,width:t,height:o,onLoad:()=>a(!0),style:{transition:"opacity 0.2s ease",opacity:r?1:0}})})},rs={duration:.2,ease:[.26,.08,.25,1]},rd={duration:.16,ease:[.26,.08,.25,1]},rl=()=>{var e,n;let t=rm(),{isSignedIn:o,reset:i}=ny(),r=eg(),[a,c]=(0,M.useState)(o?"signedIn":"signedOut"),d=nD({}),l="signedIn"===a?{heading:d.signInWithEthereumScreen_signedIn_heading,h1:d.signInWithEthereumScreen_signedIn_h1,p:d.signInWithEthereumScreen_signedIn_p,button:d.signInWithEthereumScreen_signedIn_button}:{heading:d.signInWithEthereumScreen_signedOut_heading,h1:d.signInWithEthereumScreen_signedOut_h1,p:d.signInWithEthereumScreen_signedOut_p,button:d.signInWithEthereumScreen_signedOut_button};(0,M.useEffect)(()=>{o&&c("signedIn")},[]),(0,M.useEffect)(()=>{o||c("signedOut")},[o]);let{address:p}=(0,s.F)(),h=(()=>{let e={svg:null,default:null};return Array.from(document.getElementsByTagName("link")).forEach(n=>{("icon"===n.getAttribute("rel")||"shortcut icon"===n.getAttribute("rel"))&&n.getAttribute("href")&&("image/svg+xml"===n.getAttribute("type")?e.svg=n.getAttribute("href"):e.default=n.getAttribute("href"))}),e})(),u=null!==(n=null!==(e=V())&&void 0!==e?e:h.svg)&&void 0!==n?n:h.default;return(0,A.jsx)(eP,{style:{width:278},children:(0,A.jsxs)(eX,{style:{padding:0,marginTop:-10},children:[(0,A.jsx)(rn,{children:(0,A.jsx)(F.N,{exitBeforeEnter:!0,children:(0,A.jsx)(O.P.div,{initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:rd,children:(0,A.jsx)(eq,{style:{height:42},children:(0,A.jsx)(nP,{children:l.h1})})},ex(l.h1).toString())})}),(0,A.jsxs)(rr,{$connected:o,children:[(0,A.jsx)("div",{style:{position:"absolute",inset:0},children:(0,A.jsx)(ri,{width:"262",height:"134",viewBox:"0 0 262 134",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,A.jsx)(O.P.rect,{x:"0",y:"0",rx:"12",width:"262",height:"134",strokeDasharray:"3 3",animate:{strokeDashoffset:[0,-6]},transition:{duration:.4,ease:"linear",repeat:1/0}})})}),(0,A.jsx)(O.P.div,{initial:!r&&{opacity:0,x:50,scale:.8},animate:{opacity:1,x:0,scale:1},transition:rs,children:(0,A.jsx)(rt,{children:(0,A.jsx)(iM,{address:p,size:64})})},"avatarImage"),(0,A.jsx)(O.P.div,{initial:!r&&{scale:.6},animate:{scale:1},transition:{...rs},children:(0,A.jsx)(ro,{children:(0,A.jsx)(nm,{})})},"tickIcon"),(0,A.jsx)(O.P.div,{initial:!r&&{opacity:0,x:-40,scale:.8},animate:{opacity:1,x:0,scale:1},transition:{...rs},children:(0,A.jsx)(rt,{children:u?(0,A.jsx)(rc,{src:u,alt:"app"}):(0,A.jsx)(i_.UnknownChain,{})})},"appLogo")]},"status"),(0,A.jsx)(F.N,{exitBeforeEnter:!0,children:(0,A.jsx)(O.P.div,{style:{paddingBottom:r?24:12},initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:rd,children:(0,A.jsx)(eq,{style:{height:42,marginTop:-1,marginBottom:-3},children:(0,A.jsx)(nP,{children:l.p})})},ex(l.p).toString())}),(0,A.jsx)(ra,{showSignOutButton:"signedIn"===a,onSignIn:()=>{setTimeout(()=>{t.setOpen(!1)},1e3)}})]})})},rp={},rh=({mode:e="auto",theme:n="auto",customTheme:t=rp,lang:o="en-US"})=>{var i;let r=rm(),{isConnected:a,chain:c}=(0,s.F)(),d=ot(null==c?void 0:c.id),l=!((null===(i=r.options)||void 0===i?void 0:i.enforceSupportedChains)&&a&&!d),p=l&&r.route!==rg.CONNECTORS&&r.route!==rg.PROFILE,h=l&&r.route!==rg.PROFILE,u={onboarding:(0,A.jsx)(tj,{}),about:(0,A.jsx)(tJ,{}),download:(0,A.jsx)(ib,{}),connectors:(0,A.jsx)(ov,{}),mobileConnectors:(0,A.jsx)(oO,{}),connect:(0,A.jsx)(ix,{}),profile:(0,A.jsx)(i8,{}),switchNetworks:(0,A.jsx)(i6,{}),signInWithEthereum:(0,A.jsx)(rl,{})};function g(){r.setOpen(!1)}return(0,M.useEffect)(()=>{var e;a?(r.route!==rg.PROFILE||r.route!==rg.SIGNINWITHETHEREUM)&&(!r.signInWithEthereum||(null===(e=r.options)||void 0===e?void 0:e.disableSiweRedirect)?g():r.setRoute(rg.SIGNINWITHETHEREUM)):g()},[a]),(0,M.useEffect)(()=>r.setMode(e),[e]),(0,M.useEffect)(()=>r.setTheme(n),[n]),(0,M.useEffect)(()=>r.setCustomTheme(t),[t]),(0,M.useEffect)(()=>r.setLang(o),[o]),(0,M.useEffect)(()=>{let e=P();if(!e||!r.open)return;let n=document.createElement("meta");return n.setAttribute("property","og:title"),n.setAttribute("content",e),document.head.prepend(n),()=>{document.head.removeChild(n)}},[r.open]),(0,A.jsx)(nh,{theme:n,customTheme:t,mode:e,children:(0,A.jsx)(n0,{open:r.open,pages:u,pageId:r.route,onClose:l?g:void 0,onInfo:h?()=>r.setRoute(rg.ABOUT):void 0,onBack:p?()=>{r.route===rg.SIGNINWITHETHEREUM?r.setRoute(rg.PROFILE):r.route===rg.SWITCHNETWORKS?r.setRoute(rg.PROFILE):r.route===rg.DOWNLOAD?r.setRoute(rg.CONNECT):r.setRoute(rg.CONNECTORS)}:void 0})})},ru=({onConnect:e,onDisconnect:n})=>{(0,C.U)({onConnect:({address:n,connector:t,isReconnected:o})=>{o||null==e||e({address:n,connectorId:null==t?void 0:t.id})},onDisconnect:()=>null==n?void 0:n()})},rg={ONBOARDING:"onboarding",ABOUT:"about",CONNECTORS:"connectors",MOBILECONNECTORS:"mobileConnectors",CONNECT:"connect",DOWNLOAD:"download",PROFILE:"profile",SWITCHNETWORKS:"switchNetworks",SIGNINWITHETHEREUM:"signInWithEthereum"},rx=(0,M.createContext)(null),rb=({children:e,theme:n="auto",mode:t="auto",customTheme:o,options:i,onConnect:r,onDisconnect:a,debugMode:c=!1})=>{var d,l,p,h;if(!M.useContext(v.R))throw Error("ConnectKitProvider must be within a WagmiProvider");if(M.useContext(rx))throw Error("Multiple, nested usages of ConnectKitProvider detected. Please use only one.");ru({onConnect:r,onDisconnect:a});let u=oe(),g=nY("injected"),x=Object.assign({},{language:"en-US",hideBalance:!1,hideTooltips:!1,hideQuestionMarkCTA:!1,hideNoWalletCTA:!1,walletConnectCTA:"link",hideRecentBadge:!1,avoidLayoutShift:!0,embedGoogleFonts:!1,truncateLongENSAddress:!0,walletConnectName:void 0,reducedMotion:!1,disclaimer:null,bufferPolyfill:!0,customAvatar:void 0,initialChainId:null===(d=null==u?void 0:u[0])||void 0===d?void 0:d.id,enforceSupportedChains:!1,ethereumOnboardingUrl:void 0,walletOnboardingUrl:void 0,disableSiweRedirect:!1},i);"undefined"!=typeof window&&x.bufferPolyfill&&(window.Buffer=null!==(l=window.Buffer)&&void 0!==l?l:_.Buffer);let[b,m]=(0,M.useState)(n),[C,f]=(0,M.useState)(t),[k,w]=(0,M.useState)(null!=o?o:{}),[y,j]=(0,M.useState)("en-US"),[S,N]=(0,M.useState)(!1),[E,L]=(0,M.useState)({id:""}),[I,O]=(0,M.useState)(rg.CONNECTORS),[F,W]=(0,M.useState)(""),[z,D]=(0,M.useState)(0);x.embedGoogleFonts&&function(e){var n,t;let o=null!==(n=({web95:"Lato",retro:"Nunito",midnight:"Inter",minimal:"Inter",rounded:"Nunito"})[e])&&void 0!==n?n:null;t=null!=o?o:"",(0,M.useEffect)(()=>{if(!t)return;t=t.replace(/ /g,"+");let e=document.createElement("link");e.href="https://fonts.googleapis.com",e.rel="preconnect";let n=document.createElement("link");n.href="https://fonts.gstatic.com",n.rel="preconnect",n.crossOrigin="true";let o=document.createElement("link");return o.href=`https://fonts.googleapis.com/css2?family=${t}:wght@400;500;600&display=swap`,o.rel="stylesheet",document.head.appendChild(e),document.head.appendChild(n),document.head.appendChild(o),()=>{document.head.removeChild(e),document.head.removeChild(n),document.head.removeChild(o)}},[t])}(n),(0,M.useEffect)(()=>m(n),[n]),(0,M.useEffect)(()=>j(x.language||"en-US"),[x.language]),(0,M.useEffect)(()=>W(null),[I,S]);let{chain:R,isConnected:B}=(0,s.F)(),H=ot(null==R?void 0:R.id);(0,M.useEffect)(()=>{B&&x.enforceSupportedChains&&!H&&(N(!0),O(rg.SWITCHNETWORKS))},[B,H,R,I,S]),(0,M.useEffect)(()=>{X()&&(null==g||g.connect())},[g]);let U=c?console.log:()=>{},Z={theme:b,setTheme:m,mode:C,setMode:f,customTheme:o,setCustomTheme:w,lang:y,setLang:j,open:S,setOpen:N,route:I,setRoute:O,connector:E,setConnector:L,signInWithEthereum:null!==(h=null===(p=M.useContext(nw))||void 0===p?void 0:p.enabled)&&void 0!==h&&h,onConnect:r,options:x,errorMessage:F,debugMode:c,log:U,displayError:(e,n)=>{W(e),console.log("---------CONNECTKIT DEBUG---------"),console.log(e),n&&console.table(n),console.log("---------/CONNECTKIT DEBUG---------")},resize:z,triggerResize:()=>D(e=>e+1)};return(0,M.createElement)(rx.Provider,{value:Z},(0,A.jsx)(A.Fragment,{children:(0,A.jsx)(oi,{enabled:S,children:(0,A.jsxs)(T.NP,{theme:ew,children:[e,(0,A.jsx)(rh,{lang:y,theme:b,mode:t,customTheme:k})]})})}))},rm=()=>{let e=M.useContext(rx);if(!e)throw Error("ConnectKit Hook must be inside a Provider.");return e},rC={disconnected:[rg.CONNECTORS,rg.ABOUT,rg.ONBOARDING,rg.MOBILECONNECTORS,rg.ONBOARDING],connected:[rg.PROFILE,rg.SWITCHNETWORKS,rg.SIGNINWITHETHEREUM]},rv=[...rC.connected,...rC.disconnected],rf=({onConnect:e,onDisconnect:n}={})=>{let t=rm();ru({onConnect:e,onDisconnect:n});let{isConnected:o}=(0,s.F)(),{signIn:i}=ny(),r=()=>{t.setOpen(!1)},a=()=>{t.setOpen(!0)},c=e=>{let n=e;rv.includes(e)?o?rC.connected.includes(e)||(n=rg.PROFILE,t.log(`Route ${e} is not a valid route when connected, navigating to ${n} instead.`)):rC.disconnected.includes(e)||(n=rg.CONNECTORS,t.log(`Route ${e} is not a valid route when disconnected, navigating to ${n} instead.`)):(n=o?rg.PROFILE:rg.CONNECTORS,t.log(`Route ${e} is not a valid route, navigating to ${n} instead.`)),t.setRoute(n),a()};return{open:t.open,setOpen:e=>{e?c(o?rg.PROFILE:rg.CONNECTORS):r()},openAbout:()=>c(rg.ABOUT),openOnboarding:()=>c(rg.ONBOARDING),openProfile:()=>c(rg.PROFILE),openSwitchNetworks:()=>c(rg.SWITCHNETWORKS),openSIWE:e=>{c(rg.SIGNINWITHETHEREUM),e&&i()}}},rk=ey(O.P.div)`
  top: 0;
  bottom: 0;
  left: 0;
  display: inline-flex;
...
`,rN=({children:e,variant:n="primary",autoSize:t=!0,duration:o=.3,style:i})=>{let[r,a]=(0,B.A)();return(0,A.jsx)(rj,{className:n,initial:!1,animate:t?{width:a.width>10?a.width:"auto"}:void 0,transition:{duration:o,ease:[.25,1,.5,1],delay:.01},style:i,children:(0,A.jsx)("div",{ref:r,style:{whiteSpace:"nowrap",width:"fit-content",position:"relative",padding:"0 12px"},children:e})})},rE=ey(O.P.div)`
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 8px;
...
`,rA=ey.div`
  ...
  span {
    ...
    border-radius: 4px;
    background: currentColor;
    animation: ${rL} 1000ms ease infinite both;
  }
`,rM=({hideIcon:e,hideSymbol:n})=>{let t=iE(),[o,i]=(0,M.useState)(!0),{address:r,chain:a}=(0,s.F)();oe();let c=ot(null==a?void 0:a.id),d=(0,D.jE)(),{data:l}=(0,f.y)({watch:!0}),{data:p,queryKey:h}=(0,m.A)({address:r,chainId:null==a?void 0:a.id});(0,M.useEffect)(()=>{(null==l||l)&&d.invalidateQueries({queryKey:h})},[l,h]);let u=iO.find(e=>e.id===(null==a?void 0:a.id)),g=`${t&&(null==p?void 0:p.formatted)!==void 0?`balance-${null==u?void 0:u.id}-${null==p?void 0:p.formatted}`:"balance-loading"}`;return(0,M.useEffect)(()=>{i(!1)},[]),(0,A.jsx)("div",{style:{position:"relative"},children:(0,A.jsx)(F.N,{initial:!1,children:(0,A.jsx)(O.P.div,{initial:(null==p?void 0:p.formatted)!==void 0&&o?{opacity:1}:{opacity:0,position:"absolute",top:0,left:0,bottom:0},animate:{opacity:1,position:"relative"},exit:{opacity:0,position:"absolute",top:0,left:0,bottom:0},transition:{duration:.4,ease:[.25,1,.5,1],delay:.4},children:r&&t&&(null==p?void 0:p.formatted)!==void 0?c?(0,A.jsxs)(rE,{children:[!e&&(0,A.jsx)(i2,{id:null==a?void 0:a.id}),(0,A.jsx)("span",{style:{minWidth:32},children:ed(Number(null==p?void 0:p.formatted))}),!n&&` ${null==p?void 0:p.symbol}`]}):(0,A.jsxs)(rE,{children:[!e&&(0,A.jsx)(i2,{id:null==a?void 0:a.id}),(0,A.jsx)("span",{style:{minWidth:32},children:"???"})]}):(0,A.jsxs)(rE,{children:[!e&&(0,A.jsx)(i2,{id:null==a?void 0:a.id}),(0,A.jsx)("span",{style:{minWidth:32},children:(0,A.jsxs)(rA,{children:[(0,A.jsx)("span",{style:{animationDelay:"0ms"}}),(0,A.jsx)("span",{style:{animationDelay:"50ms"}}),(0,A.jsx)("span",{style:{animationDelay:"100ms"}})]})})]})},g)})})},rI={initial:{zIndex:2,opacity:0,x:"-100%"},animate:{opacity:1,x:.1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,opacity:0,x:"-100%",pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},r_={initial:{zIndex:2,opacity:0,x:"100%"},animate:{x:.2,opacity:1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,x:"100%",opacity:0,pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},rO={initial:{opacity:0},animate:{opacity:1,transition:{duration:.3,ease:[.25,1,.5,1]}},exit:{position:"absolute",opacity:0,transition:{duration:.3,ease:[.25,1,.5,1]}}},rF=({children:e})=>{let n=iE(),t=rm(),{open:o,setOpen:i}=rf(),{address:r,isConnected:a,chain:c}=(0,s.F)(),d=ot(null==c?void 0:c.id),l=iA(),{data:p}=(0,g.v)({chainId:1,address:r,config:l});return e&&n?(0,A.jsx)(A.Fragment,{children:e({show:function(){i(!0),t.setRoute(a?rg.PROFILE:rg.CONNECTORS)},hide:function(){i(!1)},chain:c,unsupported:!d,isConnected:!!r,isConnecting:o,address:r,truncatedAddress:r?ec(r):void 0,ensName:null==p?void 0:p.toString()})}):null};function rW({label:e,showAvatar:n,separator:t}){var o;let i=nD({}),r=rm(),{isSignedIn:a}=ny(),{address:c,chain:d}=(0,s.F)(),l=ot(null==d?void 0:d.id),p=iA(),{data:h}=(0,g.v)({chainId:1,address:c,config:p}),u=i.connectWallet;return(0,A.jsx)(F.N,{initial:!1,children:c?(0,A.jsxs)(rk,{initial:"initial",animate:"animate",exit:"exit",variants:r_,style:{height:40},children:[n&&(0,A.jsxs)(rw,{children:[(0,A.jsxs)(F.N,{initial:!1,children:[a&&(0,A.jsx)(O.P.div,{style:{zIndex:2,position:"absolute",bottom:0,right:0},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,A.jsx)(nk,{})}),!l&&(0,A.jsx)(ry,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,A.jsx)("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,A.jsx)("path",{d:"M1.68831 13.5H12.0764C13.1026 13.5 13.7647 12.7197 13.7647 11.763C13.7647 11.4781 13.6985 11.1863 13.5462 10.9149L8.34225 1.37526C8.02445 0.791754 7.45505 0.5 6.88566 0.5C6.31627 0.5 5.73364 0.791754 5.42246 1.37526L0.225108 10.9217C0.0728291 11.1863 0 11.4781 0 11.763C0 12.7197 0.662083 13.5 1.68831 13.5ZM6.88566 8.8048C6.49503 8.8048 6.27655 8.5809 6.26331 8.1738L6.16399 5.0595C6.15075 4.64562 6.44869 4.34708 6.87904 4.34708C7.30278 4.34708 7.61396 4.6524 7.60071 5.06628L7.5014 8.16701C7.48154 8.5809 7.26305 8.8048 6.88566 8.8048ZM6.88566 11.3492C6.44207 11.3492 6.07792 11.0303 6.07792 10.5757C6.07792 10.1211 6.44207 9.80219 6.88566 9.80219C7.32926 9.80219 7.69341 10.1143 7.69341 10.5757C7.69341 11.0371 7.32264 11.3492 6.88566 11.3492Z",fill:"currentColor"})})})]}),(0,A.jsx)(iM,{size:24,address:c})]}),(0,A.jsx)("div",{style:{position:"relative",paddingRight:n?1:0},children:(0,A.jsx)(F.N,{initial:!1,children:h?(0,A.jsx)(rk,{initial:"initial",animate:"animate",exit:"exit",variants:rO,style:{position:h?"relative":"absolute"},children:(null===(o=r.options)||void 0===o?void 0:o.truncateLongENSAddress)?es(h,20):h},"ckEnsName"):(0,A.jsxs)(rk,{initial:"initial",animate:"animate",exit:"exit",variants:rO,style:{position:h?"absolute":"relative"},children:[ec(c,t)," "]},"ckTruncatedAddress")})})]},"connectedText"):(0,A.jsx)(rk,{initial:"initial",animate:"animate",exit:"exit",variants:rI,style:{height:40},children:e||u},"connectWalletText")})}function rT({label:e,showBalance:n=!1,showAvatar:t=!0,theme:o,mode:i,customTheme:r,onClick:a}){var c;let d=iE(),l=rm(),{isConnected:p,address:h,chain:u}=(0,s.F)(),g=ot(null==u?void 0:u.id);function x(){l.setOpen(!0),l.setRoute(p?rg.PROFILE:rg.CONNECTORS)}let b=["web95","rounded","minimal"].includes(null!==(c=null!=o?o:l.theme)&&void 0!==c?c:"")?"....":void 0;if(!d)return null;let m=n&&g,C=h&&m;return(0,A.jsx)(eW,{$useTheme:null!=o?o:l.theme,$useMode:null!=i?i:l.mode,$customTheme:null!=r?r:l.customTheme,children:(0,A.jsxs)(rS,{onClick:()=>{a?a(x):x()},children:[m&&(0,A.jsx)(F.N,{initial:!1,children:C&&(0,A.jsx)(O.P.div,{initial:{opacity:0,x:"100%",width:0,marginRight:0},animate:{opacity:1,x:0,width:"auto",marginRight:-24,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{opacity:0,x:"100%",width:0,marginRight:0,transition:{duration:.4,ease:[.25,1,.5,1]}},children:(0,A.jsx)(rN,{variant:"secondary",theme:null!=o?o:l.theme,mode:null!=i?i:l.mode,customTheme:null!=r?r:l.customTheme,style:{overflow:"hidden"},children:(0,A.jsx)(O.P.div,{style:{paddingRight:24},children:(0,A.jsx)(rM,{hideSymbol:!0})})})},"balance")}),(0,A.jsx)(rN,{theme:null!=o?o:l.theme,mode:null!=i?i:l.mode,customTheme:null!=r?r:l.customTheme,style:m&&n&&h&&("retro"===o||"retro"===l.theme)?{boxShadow:"var(--ck-connectbutton-balance-connectbutton-box-shadow)",borderRadius:"var(--ck-connectbutton-balance-connectbutton-border-radius)",overflow:"hidden"}:{overflow:"hidden"},children:(0,A.jsx)(rW,{separator:b,showAvatar:t,label:e})})]})})}rF.displayName="ConnectKitButton.Custom",rT.Custom=rF;let rz=(0,T.i7)`
  0%{ transform:none; }
...
`;ey.div`
  ...
  opacity: 0;
  &.play {
    animation: ${rD} 1300ms 200ms cubic-bezier(0.16, 1, 0.6, 1) both;
  }
`,ey.div`
  z-index: 1;
  position: absolute;
  inset: 0;
  &.shake {
    animation: ${rz} 300ms 100ms cubic-bezier(0.16, 1, 0.6, 1) both;
  }
`,ey.div`
  z-index: 1;
  position: absolute;
